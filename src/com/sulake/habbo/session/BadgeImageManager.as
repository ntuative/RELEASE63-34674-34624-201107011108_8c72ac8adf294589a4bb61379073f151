package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1966:String = "normal_badge";
      ...
      private function getBadgeImageInternal(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         switch(param2)
         {
            case const_1966:
               ...
               {
                  _loc5_ = this.var_136.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1259:
               if(this.var_136 != null)
               {
                  if(this.var_136 != null)
                  {
                     _loc5_ = this.var_136.getKey("group.badge.url");

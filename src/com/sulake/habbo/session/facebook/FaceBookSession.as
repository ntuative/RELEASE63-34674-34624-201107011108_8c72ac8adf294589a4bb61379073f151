package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1086:String = "FlashExternalInterface.authenticateFacebook";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ...
            ExternalInterface.call(const_1086);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1086);
         }
      }

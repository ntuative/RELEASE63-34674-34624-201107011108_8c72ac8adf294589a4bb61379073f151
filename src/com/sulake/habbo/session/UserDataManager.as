package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      private static const const_1545:int = 1;
      
      private static const const_1544:int = 2;
      
      private static const const_2078:int = 3;
      ...
      {
         return this.getUserDataByType(param1,const_1545);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = this.var_1015.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         return this.getUserDataByType(param1,const_1544);
      }

package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1911:GroupDetailsView;
      ...
      private var var_668:ProductDataParser;
      ...
      private var var_1915:UserTagManager;
      
      private var var_1252:BadgeImageManager;
      
      private var var_1253:HabboGroupInfoManager;
      
      private var var_1011:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3077 = [];
         this.var_1915 = new UserTagManager(events);
         this.var_1253 = new HabboGroupInfoManager(this,events);
         this.var_1011 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_330)
         {
            this.var_330.removeEventListener(FurnitureDataParser.const_132,this.onFurnitureReady);
            this.var_330.dispose();
            this.var_330 = null;
         }
         if(this.var_668)
         {
            this.var_668.removeEventListener(ProductDataParser.const_132,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         if(this.var_136 == null || this._localization == null)
         {
            return;
         }
         this.var_1252 = new BadgeImageManager(context.root.assets,events,this.var_136,this._localization);
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_330)
         {
            ...
            this.var_330 = new FurnitureDataParser(this.var_556,this._wallItems,this.var_555,this._localization);
            this.var_330.addEventListener(FurnitureDataParser.const_132,this.onFurnitureReady);
            if(this.var_136.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_136.getKey("furnidata.load.url");
      ...
      private function onFurnitureReady(param1:Event = null) : void
      {
         var _loc2_:* = null;
         this.var_330.removeEventListener(FurnitureDataParser.const_132,this.onFurnitureReady);
         for each(_loc2_ in this.var_1012)
         {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1913 = _loc2_.clubLevel;
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2653 = _loc3_.respectTotal;
         this.var_1250 = _loc3_.respectLeft;
         this.var_813 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_970 = _loc3_.sex;
         this.var_1817 = _loc3_.realName;
         this.var_2607 = _loc3_.identityId;
         this.var_1011.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_970 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_970));
         }
      }
      ...
      {
         return this.var_1914 >= SecurityLevelEnum.const_1237;
      }
      
      public function getUserTags(param1:int) : Array
      {
         return this.var_1915.getTags(param1);
      }
      
      public function getBadgeImage(param1:String) : BitmapData
      {
         return this.var_1252.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1252.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1911 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1253.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1911.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1253.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1253.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1252.getBadgeImage(param1,BadgeImageManager.const_1259);
      }
      ...
      {
         return this.var_1011.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1011.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1011.unignoreUser(param1);
      }
      ...
      public function giveRespect(param1:int) : void
      {
         ...
         if(param1 < 0 || this.var_1250 < 1 || _loc2_ == null)
         {
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_813 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_813 = this.var_813 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_556.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_555.getValue(param1);
      ...
      public function openHabboHomePage(param1:int) : void
      {
         ...
         {
            urlString = this.var_136.getKey("link.format.userpage");
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1251.indexOf(param1) == -1)
         {
         ...
         {
            _loc2_ = this.var_136.getKey("productdata.load.url");
            this.var_668 = new ProductDataParser(_loc2_,this.var_1382);
            this.var_668.addEventListener(ProductDataParser.const_132,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         {
            if(this.var_1012.indexOf(param1) == -1)
            {
               this.var_1012.push(param1);
            }
            return null;
         }
         var _loc2_:Array = this.var_556.getValues();

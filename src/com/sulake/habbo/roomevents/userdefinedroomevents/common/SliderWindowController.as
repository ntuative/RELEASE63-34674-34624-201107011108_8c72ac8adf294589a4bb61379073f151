package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1366:Number = 1.0;
      
      private var var_725:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1366,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1102);
         }
      ...
      {
         return int(this.var_1746 * (Number(param1 - this._minValue) / (this.var_1366 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1746 * (this.var_1366 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1103)
         {
            if(param1.type == WindowMouseEvent.const_56 || param1.type == WindowMouseEvent.const_248)
            {
               this.var_1103 = false;
            }
         }
         if(!this.var_1103 || param1.type != WindowEvent.const_422)
         {
            return;
         }
         if(this.var_725 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_725) * this.var_725;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_725 != 0)
            {
               _loc3_ = this.var_1102 + this.var_725;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_762 != null)
            {
               ...
               this.var_1746 = _loc1_.width - _loc2_.width;
            }
         }

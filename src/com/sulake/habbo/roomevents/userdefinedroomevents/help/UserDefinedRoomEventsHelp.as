package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1829 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1211 = this.var_1829.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1211)
         {
            this.var_1211.procedure = this.onButtonClick;
         }
         this.var_1212 = this.var_1829.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1212)
         {
      ...
      {
         if(this.var_280 >= this.var_77.length - 1)
         {
         ...
         if(this.var_280 <= 0)
         {
            this.var_1211.disable();
         }
         else
         {
            this.var_1211.enable();
         }
      }
      ...
      {
         ++this.var_280;
         this.var_280 = Math.min(this.var_280,this.var_77.length - 1);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_77[this.var_280][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_77[this.var_280][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_77[this.var_280][1]).value;

package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1594:int = 2;
      ...
      private var var_2017:TriggerConfs;
      
      private var var_2018:ActionTypes;
      
      private var var_2019:ConditionTypes;
      
      private var var_300:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_849:RoomObjectHightLighter;
      
      private var var_199:UserDefinedRoomEventsHelp;
      
      private var var_1311:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2017 = new TriggerConfs();
         this.var_2018 = new ActionTypes();
         this.var_2019 = new ConditionTypes();
         this.var_300 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_849 = new RoomObjectHightLighter(param1);
         this.var_199 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1311 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_94.assets,0,20,1);
         this.var_1311.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1311.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_849.hideAll(this.var_300);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_849.showAll(this.var_300);
         if(this.var_37 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_37);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1311.setValue(_loc6_);
         }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1311.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_199.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1594) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1594 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2019);

package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2119:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107011102));
         this.var_142 = new Map();
         this.var_142.add(HabboHelpViewEnum.const_1900,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_215,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_551,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_347,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_285,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_441,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_844,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_258,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_142.add(HabboHelpViewEnum.const_1224,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_142.add(HabboHelpViewEnum.const_1356,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_142.add(HabboHelpViewEnum.const_1005,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2119)
         {
            this.var_585 = new Array();
         }
         else if(param2)
         {
            if(this.var_585.length == 0 || param1 != this.var_417)
            {
               this.var_585.push(this.var_417);
            }
         }
         this.var_417 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            ...
            case CallForHelpResultEnum.const_1162:
               this.showUI(HabboHelpViewEnum.const_1356);
               break;
            case CallForHelpResultEnum.const_1322:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_142.getValue(HabboHelpViewEnum.const_215) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_620));
      }
      ...
      {
         return this.var_142.getValue(this.var_417);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2857 = this._window.width - _loc3_.width;
         this.var_2858 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2858;
         this._window.width = _loc1_.width + this.var_2857;
      }
      ...
      private function setBackButtonActiveState(param1:Boolean = false) : void
      {
         ...
         if(this.var_721.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_721.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_721.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_418.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_721[1],this.var_721[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_721[0],this.var_721[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_417 == HabboHelpViewEnum.const_215 || this.var_585.length == 0)
         {
            return;
         }
         if(this.var_418 == null)
         {
            ...
            this.var_418 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_418.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_418.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_418 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_418 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_418 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}

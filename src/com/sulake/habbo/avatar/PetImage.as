   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_57)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1684);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_634);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_634);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_634);
            if(_loc10_ != null)
            {
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_634);
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_529 = this.var_529 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_359.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_1123);
         this.getCache().resetBodyPartCache(this.var_1123);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1683 = this._structure.sortActions(this.var_359);
         ...
         {
            this.var_803 = this._structure.getCanvasOffsets(this.var_1683,this._scale,this.var_103);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1683)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_439)
               {
                  this.var_1084 = true;
               }

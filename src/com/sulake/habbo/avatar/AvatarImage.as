package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1466:String = AvatarSetType.const_41;
      ...
      private var var_1123:IActiveActionData;
      ...
      protected var var_1409:Boolean = false;
      ...
      private var var_2384:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1466,const_1465);
         this.var_359 = new Array();
         this.var_1123 = new ActiveActionData(AvatarAction.const_461);
         this.var_1123.definition = this._structure.getActionDefinition(const_1464);
         this.resetActions();
      ...
      {
         param2 += this.var_1791;
         if(param2 < AvatarDirectionAngle.const_1301)
         {
            param2 = AvatarDirectionAngle.const_357 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_357)
         {
            param2 -= NaN;
         }
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_634,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_278.length == 1 && this.var_103 == this.var_1835)
         {
            return this.var_103 + this.var_529 + this.var_634 % 4;
         }
         if(this.var_278.length == 2)
         {
            for each(_loc1_ in this.var_278)
            {
               ...
               {
                  return this.var_103 + this.var_529 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_634 % 11;
                  return this.var_103 + "_" + this.var_1835 + this.var_529 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2385 || param2 != this.var_2386 || param1 != this.var_2384)
         {
            this.var_2385 = param3;
            this.var_2386 = param2;
            this.var_2384 = param1;
            this.var_1790 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1409 || this.var_46 == null || (this.var_46.width != _loc5_.width || this.var_46.height != _loc5_.height))
         {
            if(this.var_46 != null && !this.var_1409)
            {
               this.var_46.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_634);
         ...
         if(this.var_605 != null)
         {
            if(this.var_605.paletteIsGrayscale)
            {
               ...
               this.var_46 = _loc13_;
               this.var_46.paletteMap(this.var_46,this.var_46.rect,new Point(0,0),this.var_605.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_634);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_359.length)
         {
            _loc3_ = this.var_359[_loc4_];
         ...
         this.var_359.push(new ActiveActionData(param1,param2,this.var_634));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_313 = this.var_1123;
         this.var_313.definition = this.var_1123.definition;
         this.resetBodyPartCache(this.var_1123);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_529 = "";
         this.var_278 = this._structure.sortActions(this.var_359);
         if(this.var_278 == null)
         {
         ...
         {
            this.var_803 = this._structure.getCanvasOffsets(this.var_278,this._scale,this.var_103);
            for each(_loc4_ in this.var_278)
            {
               this.var_529 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_376)
               {
            ...
            if(this.var_1191 != this.var_529)
            {
               _loc1_ = true;
               this.var_1191 = this.var_529;
            }
         }
         this.var_1466 = true;
         return _loc1_;
            ...
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1791 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_354 || _loc1_.actionType == AvatarAction.const_250 || _loc1_.actionType == AvatarAction.const_439)
               {
                  this.var_1084 = true;
               }
            }

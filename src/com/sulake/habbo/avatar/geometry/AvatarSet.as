package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2574 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         ...
         {
            this.var_1906.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1906.concat();
         for each(_loc3_ in this.var_1246)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2599 = _loc6_;
      }

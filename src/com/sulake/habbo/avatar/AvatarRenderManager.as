package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2355:String = "hd-99999-99999";
      ...
      private var var_810:PaletteManager;
      ...
      private var var_1899:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_731 = RenderMode.const_1760;
         ...
         this.var_122.add(AvatarType.const_125,_loc4_);
         ...
         this.var_810 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_329.init();
         this.var_810.init();
         _loc2_ = this.var_122.getValue(AvatarType.const_125) as AvatarStructure;
         if(_loc2_)
         {
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_122.getValue(AvatarType.const_125) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_136.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_249 == null)
               {
                  ...
                  _loc6_ = this.var_136.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_136.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_960)
         {
            if(this.var_2586 && this.var_2588 && this.var_2587)
            {
               this.var_960 = true;
      ...
      {
         var _loc5_:AvatarStructure = this.var_122.getValue(AvatarType.const_125) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1899)
         {
            this.var_1899 = new AvatarFigureContainer(this.const_2355);
         }
         this.var_249.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1899,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1743)
         {
      ...
      {
         var _loc3_:AvatarStructure = this.var_122.getValue(AvatarType.const_125) as AvatarStructure;

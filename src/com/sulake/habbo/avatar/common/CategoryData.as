package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_276)
         {
            for each(_loc2_ in this.var_276 as Array)
            {
               if(_loc2_)
               {
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_276 || this.var_276.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_276[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_276.length <= param1)
         {
            return null;
         }
         return this.var_276[param1] as Array;
      }

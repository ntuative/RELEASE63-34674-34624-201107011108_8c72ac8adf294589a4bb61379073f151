package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_645 = _loc4_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_645.width,this.var_645.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_645,this.var_645.rect,new Point(0,0));
         }
            ...
            if(this.var_946)
            {
               switch(this.var_946.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_737;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_43:
                     _loc4_.style = HabboIconType.const_813;
                     _loc4_.visible = true;
               }
            }
            else

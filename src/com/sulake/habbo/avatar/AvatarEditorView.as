package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1694:IWindowContainer;
      
      public static var var_2227:int = 6710886;
      
      private static const const_1644:int = 5000;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1323 = [];
         this.var_1584 = [AvatarEditorFigureCategory.const_951,AvatarEditorFigureCategory.const_57,AvatarEditorFigureCategory.const_289,AvatarEditorFigureCategory.const_931,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         this.var_23 = param1;
         if(var_1407 == null)
         {
            _loc4_ = this.var_23.manager.assets.getAssetByName("AvatarEditorThumb") as XmlAsset;
            var_1407 = this.var_23.manager.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         if(var_1694 == null)
         {
            _loc5_ = this.var_23.manager.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1694 = this.var_23.manager.windowManager.buildFromXML(_loc5_.content as XML) as IWindowContainer;
         }
         this._saveTimer = new Timer(const_1644,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1584;
         }
         for each(_loc3_ in param2)
         {
            this.var_1323.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_87.position = const_1453;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_702 == null)
            {
               this.var_702 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_69,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_702.addChild(this.var_60);
            }
            _loc3_ = this.var_702.getChildIndex(this.var_60);
            if(_loc3_)
            {
               param1.removeChildAt(_loc3_);
            }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1584);
         }
         if(param1.length != this.var_1323.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1323.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         this.var_262 = this.var_60.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc1_:int = this.var_262.numSelectables - 1;
         while(_loc1_ >= 0)
         {
            _loc2_ = this.var_262.getSelectableAt(_loc1_);
            if(_loc2_ != null && this.var_1323.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1584;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_35 && (this.var_1611 == AvatarEditorSideCategory.const_110 || this.var_2815))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1611 == AvatarEditorSideCategory.const_110)
         {
            this.var_2815 = false;
            this.setSideContent(AvatarEditorSideCategory.const_604);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_604:
               break;
            case AvatarEditorSideCategory.const_617:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_617);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_346)
         {
            ...
            this.var_346 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;

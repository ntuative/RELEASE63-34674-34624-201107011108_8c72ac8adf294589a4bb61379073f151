package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2741:uint;
      
      private var var_2743:uint;
      ...
      private var var_1718:Number = 1.0;
      ...
      {
         super();
         this.var_1997 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2741 = parseInt(_loc2_,16);
         this.var_2743 = parseInt(_loc3_,16);
         ...
         this.var_786 = new ColorTransform(this.var_1716,this.var_1718,this.var_1715,this._alphaMultiplier);
         this.var_1304 = this.generatePaletteMapForGrayscale(this.var_2743,this.var_2741);
      }
      ...
      {
         return this.var_1304.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1304.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1304.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1304.getValue("alphas") as Array;
      }

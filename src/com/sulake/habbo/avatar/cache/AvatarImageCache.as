package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private var var_1521:IAvatarImage;
      ...
      private var var_401:IActiveActionData;
      
      private var var_485:AvatarImageBodyPartContainer;
      ...
      private var var_2765:ByteArray;
      
      private var var_2764:ImageData;
      
      private var var_1013:PaletteMap;
      
      private var var_1055:Array;
      
      private var var_1056:Point;
      ...
      {
         if(this.var_847 == param1)
         {
            return;
         }
         if(this.var_847 == GeometryType.const_1286 && param1 == GeometryType.const_1402 || this.var_847 == GeometryType.const_1402 && param1 == GeometryType.const_1286)
         {
            this.var_847 = param1;
            this.var_100 = null;
            return;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         this.var_401 = this._bodyPartCache.getAction();
         var _loc5_:IActiveActionData = this.var_401;
         var _loc6_:* = [];
         var _loc7_:Dictionary = new Dictionary();
         var _loc8_:Point = new Point();
         if(!(!this.var_401 || !this.var_401.definition))
         {
            if(this.var_401.definition.isAnimation)
            {
               _loc11_ = _loc3_;
               _loc12_ = this._structure.getAnimation(this.var_401.definition.state + "." + this.var_401.actionParameter);
               _loc13_ = param2 - this.var_401.startFrame;
               if(_loc12_ != null)
               {
                  _loc14_ = _loc12_.getLayerData(_loc13_,param1,this.var_401.overridingAction);
                  if(_loc14_ != null)
                  {
                     ...
                     {
                        this.var_401 = _loc14_.action;
                     }
                     if(_loc14_.type == AnimationLayerData.const_847)
                     {
                        if(_loc14_.action != null)
                        {
                     ...
                     else if(_loc14_.type == AnimationLayerData.const_506)
                     {
                        _loc3_ = _loc11_;
                     }
         ...
         if(_loc10_ == null)
         {
            _loc15_ = this._structure.getParts(param1,this.var_1521.getFigure(),_loc5_,this.var_847,_loc3_,_loc6_,_loc7_);
            _loc10_ = new AvatarImageDirectionCache(_loc15_);
            _loc9_.updateDirectionCache(_loc3_,_loc10_);
         }
         this.var_485 = _loc10_.getImageContainer(_loc4_);
         if(this.var_485 == null)
         {
            _loc16_ = _loc10_.getPartList();
            this.var_485 = this.renderBodyPart(_loc3_,_loc16_,_loc4_,this.var_401);
            if(this.var_485 == null)
            {
               return null;
            }
            _loc10_.updateImageContainer(this.var_485,_loc4_);
         }
         this.var_485.offset = _loc8_;
         return this.var_485;
      }
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         if(!this.var_100)
         {
            this.var_100 = this._structure.getCanvas(this._scale,this.var_847);
            if(!this.var_100)
            {
               return null;
            }
            this.var_2766 = new Point(0,this.var_100.height - int(this.var_100.width / 4));
         }
         var _loc5_:int = param1;
         var _loc6_:Boolean = AvatarDirectionAngle.const_1861[param1];
         var _loc9_:String = param4.definition.assetPartDefinition;
         var _loc10_:String = param4.definition.state;
         var _loc11_:Boolean = _loc10_ == AvatarAction.const_993 || _loc10_ == AvatarAction.const_439;
         ...
         while(_loc8_ >= 0)
         {
            ...
            {
               this.var_1590 = this.var_138.bodyPartId;
               this.var_200 = this.var_138.partType;
               this.var_2008 = this.var_138.partId;
               ...
               if(_loc6_)
               {
                  ...
                  else
                  {
                     ...
                     if(this.var_138.flippedPartType != this.var_200)
                     {
                        this.var_200 = this.var_138.flippedPartType;
                     }
                  }
               }
               this.var_1591 = this._scale + "_" + this.var_138.action.assetPartDefinition + "_" + this.var_200 + "_" + this.var_2008 + "_" + _loc5_ + "_" + this._frame;
               this.var_476 = this._assets.getAssetByName(this.var_1591) as BitmapDataAsset;
               if(this.var_476 == null)
               {
                  this.var_1591 = this._scale + "_std_" + this.var_200 + "_" + this.var_2008 + "_" + _loc5_ + "_0";
                  this.var_476 = this._assets.getAssetByName(this.var_1591) as BitmapDataAsset;
               }
               if(!(!this.var_476 || !this.var_476.content))
               {
                  ...
                  {
                     this.var_1013 = this._structure.renderManager.paletteManager.getPalette(this.var_138.paletteMapId);
                     if(this.var_1013 != null)
                     {
                        this.var_1054 = this.var_476.content as BitmapData;
                        this.var_201 = new BitmapData(this.var_1054.width,this.var_1054.height);
                        this.var_2765 = this.var_1013.colorize(this.var_1054.getPixels(this.var_1054.rect));
                        this.var_201.setPixels(this.var_201.rect,this.var_2765);
                     }
                     else
                     {
                        this.var_201 = (this.var_476.content as BitmapData).clone();
                     }
                  }
                  else
                  {
                  ...
                  if(_loc11_ && (this.var_1590 == AvatarBodyPartType.const_289 || this.var_1590 == AvatarBodyPartType.const_1995 || this.var_1590 == AvatarBodyPartType.const_1787) && this.var_138.color != null)
                  {
                     _loc16_ = 0.7;
                  ...
                  {
                     this.var_201.colorTransform(this.var_201.rect,this.var_138.color.colorTransform);
                  }
                  if(this.var_138.isBlendable)
                  {
                     this.var_201.colorTransform(this.var_201.rect,this.var_138.blendTransform);
                  }
                  this.var_1056 = this.var_476.offset.clone();
                  if(_loc7_)
                  {
                     if(this._scale == AvatarScaleType.const_61)
                     {
                  ...
                  this.var_2764 = new ImageData(this.var_201,this.var_1056,_loc7_);
                  this.var_1055.push(this.var_2764);
               }
            }
            _loc8_--;
         }
         if(this.var_1055.length == 0)
         {
            return null;
         }
         var _loc13_:ImageData = this.createUnionImage(this.var_1055,_loc6_);
         var _loc14_:Point = new Point(-1 * _loc13_.regpoint.x,this.var_2766.y - _loc13_.regpoint.y);
         if(_loc6_)
         {
            if(this._scale == AvatarScaleType.const_61)
            {
         ...
         _loc8_ = this.var_1055.length - 1;
         while(_loc8_ >= 0)
         {
            _loc15_ = this.var_1055.pop();
            if(_loc15_)
            {
               _loc15_.dispose();
            }

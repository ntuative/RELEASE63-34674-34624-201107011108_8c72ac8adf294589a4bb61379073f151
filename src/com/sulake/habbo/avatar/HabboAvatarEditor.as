package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1722:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_1134:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_599 = param2;
         this.var_1134 = this.var_599.avatarRenderManager.getFigureData(AvatarType.const_125);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_744["null"] = new FigureData(this);
         this.var_744["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_744["null"];
         var _loc3_:FigureData = this.var_744["null"];
         _loc2_.loadAvatarData(const_1721,FigureData.const_88);
         _loc3_.loadAvatarData(const_1722,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_598 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_951,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_57,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_289,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_931,new LegsModel(this));
         ...
         this.var_598.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
         this.var_598.add(AvatarEditorSideCategory.const_617,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_922 != param3)
         {
            this.var_922 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_744[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1134.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1134.getPalette(param1);
      }
      ...
      private function selectDefaultCategory(param1:Array) : void
      {
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_951);
         }
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_598.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_744[this.var_970];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2200;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_922 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_728)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1694.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1976)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_922 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_922 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_598.getValue(AvatarEditorSideCategory.const_110);
      }

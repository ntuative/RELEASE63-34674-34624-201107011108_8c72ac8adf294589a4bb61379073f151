package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1110:AvatarActionManager;
      
      private var var_422:FigureData;
      
      private var var_496:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_900:AnimationManager;
      
      private var var_1123:ActionDefinition;
      
      private var var_589:String;
      
      private var var_1665:PartOffsetData;
      ...
      {
         this.var_1665.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_589);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_589);
            return;
         }
         this.var_1110 = new AvatarActionManager(param1,this.var_589,param2);
         this.var_1123 = this.var_1110.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_589);
            return false;
         }
         if(this.var_496.parse(param1))
         {
            if(this.var_589 == AvatarType.const_125)
            {
               this.var_496.getPartDefinition("ri").appendToFigure = true;
               this.var_496.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_589);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_589);
            return false;
         }
      ...
      {
         return this.var_1110.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1110.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1110.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_729[param1] = new Dictionary();
         }
         if(this.var_729[param1][param2])
         {
            return this.var_729[param1][param2];
         }
         this.var_729[param1][param2] = this.var_422.getMandatorySetTypeIds(param1,param2);
         return this.var_729[param1][param2];
      }
      ...
      {
         return this.var_1110.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_496.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_496.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1731[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_496.getActiveParts(param3.definition);
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_1123;
                           }
                           _loc12_ = this.var_496.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_496.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      {
         return this.var_1665.getOffset(param1,param2,param3,param4,param5,param6);
      }

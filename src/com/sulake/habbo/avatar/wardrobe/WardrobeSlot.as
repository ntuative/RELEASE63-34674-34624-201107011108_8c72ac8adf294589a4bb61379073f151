package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1483)
         {
            _loc5_ = this.var_27.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_115,this.var_970,this);
            if(_loc5_)
            {
         ...
         if(_loc4_)
         {
            _loc4_.visible = this.var_1483 && this._figure != null;
         }
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_970 = this.var_27.gender;
               this.var_27.handler.saveWardrobeOutfit(this.var_1811,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_27.loadAvatarInEditor(this._figure,this.var_970,this.var_27.clubMemberLevel);
               }
         }
      }

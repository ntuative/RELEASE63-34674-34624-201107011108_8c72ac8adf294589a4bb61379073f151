package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2571 = parseInt(param1.@precedence);
         this.var_2569 = String(param1.@activepartset);
         this.var_2573 = String(param1.@assetpartdefinition);
         this.var_2572 = String(param1.@lay);
         this.var_847 = String(param1.@geometrytype);
         this.var_2574 = Boolean(parseInt(param1.@main));
         this.var_2570 = Boolean(parseInt(param1.@const_682));
         this.var_2576 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2575 = _loc6_;
            }
            else
            {
               this.var_1886[_loc5_] = _loc6_;
            }
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1886[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2575;
         }
         return _loc2_;
      }

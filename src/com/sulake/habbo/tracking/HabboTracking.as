package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1096:uint = 11;
      ...
      private var var_1306:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_199:IHabboHelp;
      ...
      private var var_297:LatencyTracker = null;
      
      private var var_691:LagWarningLogger = null;
      
      private var var_475:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_297 = new LatencyTracker();
         this.var_691 = new LagWarningLogger();
         this.var_475 = new ToolbarClickTracker(this);
         this.var_1588 = new Array(const_1096);
         var _loc4_:int = 0;
         while(_loc4_ < const_1096)
         {
            this.var_1588[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1881,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1821,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_991,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1400,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1306)
            {
               this.var_1306.release(new IIDHabboWindowManager());
               this.var_1306 = null;
            }
            if(this.var_352)
            {
            ...
            if(this.var_225)
            {
               if(!this.var_225.disposed)
               {
                  ...
                  Component(this.var_225).events.removeEventListener(HabboFriendListTrackingEvent.const_512,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_199)
            {
               ...
               {
                  this.var_199.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_199.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_199.release(new IIDHabboHelp());
               this.var_199 = null;
            }
            if(this._toolbar)
            {
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_221,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_193,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_383,this.onRoomAction);
               }
      ...
      {
         this.var_1588[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_136 = IHabboConfigurationManager(param2);
         if(this.var_136)
         {
            if(this.var_297 != null)
            {
               this.var_297.configuration = this.var_136;
            }
            if(this.var_298 != null)
            {
               this.var_298.configuration = this.var_136;
            }
            ...
            if(this.var_136)
            {
               ...
               {
                  this.var_691.configure(this.var_136);
               }
               if(this.var_474 != null)
               {
                  this.var_474.configure(this.var_136);
               }
               if(this.var_475 != null)
               {
                  this.var_475.configure(this.var_136);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_778,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_766,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_71,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_541,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_297 != null)
            {
               this.var_297.communication = this._communication;
               this.var_297.connection = param1;
            }
            if(this.var_691 != null)
            {
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_541)
         {
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_778:
      ...
      {
         this.var_1306 = IHabboWindowManager(param2);
         if(this.var_1306)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_136)
            {
               if(this.var_136.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_136.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1588)
                  {
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1390,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_225).events.addEventListener(HabboFriendListTrackingEvent.const_512,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_512:
      ...
      {
         this.var_199 = param2 as IHabboHelp;
         this.var_199.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_199.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1400,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_991,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_221,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_193,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_383,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_352 = param2 as IAdManager;
         this.var_352.events.addEventListener(AdEvent.const_589,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         ...
         else if(param1.type == RoomEngineEvent.const_383)
         {
            if(this.var_342)
            {
               this.var_342.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_475)
         {
            this.var_475.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_475)
         {
            this.var_475.track(param1.type);
         }
      }
      ...
      {
         if(this.var_136 != null && !Boolean(this.var_136.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_567 > -1 && _loc2_ < this.var_567)
         {
            ++this.var_2004;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_2004);
         }
         if(this.var_567 > -1 && _loc2_ - this.var_567 > 15000)
         {
            ++this.var_2002;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_2002);
         }
         this.var_567 = _loc2_;
         if(this.var_298 != null)
         {
            this.var_298.update(param1,this.var_567);
         }
         if(this.var_297 != null)
         {
            this.var_297.update(param1,this.var_567);
         }
         if(this.var_474 != null)
         {
            this.var_474.trackUpdate(param1,this,this.var_567);
         }
         if(this.var_691 != null)
         {
            this.var_691.update(this.var_567);
         }
      }
   }
}

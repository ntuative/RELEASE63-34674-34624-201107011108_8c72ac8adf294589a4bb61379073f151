   ...
   public class RoomMessageHandler
   {
      ...
      public function setCurrentRoom(param1:int, param2:int) : void
      {
         if(this.var_1063 != 0 || this.var_1062 != 0)
         {
            if(this.var_11 != null)
            {
               this.var_11.disposeRoom(this.var_1063,this.var_1062);
            }
         }
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_1063 != _loc3_.roomId || this.var_1062 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         while(_loc15_ < _loc8_)
         {
            ...
            while(_loc19_ < _loc7_)
            {
               ...
               if(!_loc13_)
               {
                  if((_loc15_ > 0 && _loc15_ < _loc8_ - 1 || _loc19_ > 0 && _loc19_ < _loc7_ - 1) && _loc20_ != RoomPlaneParser.const_74)
                  {
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_74 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_74 && _loc3_.getTileHeight(_loc19_,_loc15_ + 1) == RoomPlaneParser.const_74)
                     {
                     ...
                     if(_loc3_.getTileHeight(_loc19_,_loc15_ - 1) == RoomPlaneParser.const_74 && _loc3_.getTileHeight(_loc19_ - 1,_loc15_) == RoomPlaneParser.const_74 && _loc3_.getTileHeight(_loc19_ + 1,_loc15_) == RoomPlaneParser.const_74)
                     {
         ...
         if(this.var_851.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_851.objectData);
            this.var_851.objectData = null;
         }
         else
         {
            this.var_851.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_851.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_851.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_753);
         var _loc8_:int = 0;
               ...
               for each(_loc18_ in _loc9_.actions)
               {
                  switch(_loc18_.actionType)
                  {
                     case "flatctrl":
                        ...
                        break;
                     case "sign":
                        this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc9_.id,RoomObjectVariableEnum.const_406,int(_loc18_.actionParameter));
                        break;
                     case "gst":
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_247,_loc6_);
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_265,_loc2_.itemType);
         }
      }
            ...
            if(_loc2_.avatar != null)
            {
               ...
               switch(_loc8_.moveType)
               {
                  case SlideObjectMessageData.const_1283:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1352:
                     _loc9_ = "std";
               }
      ...
      private function onChat(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_194,Math.ceil(_loc2_.text.length / 10));
      }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_508,_loc6_);
      }
      ...
      private function onPetExperience(param1:PetExperienceEvent) : void
      {
         ...
         var _loc3_:int = this.getRoomId(_loc2_.roomId);
         var _loc4_:int = this.getRoomCategory(_loc2_.roomCategory);
         this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.petRoomIndex,RoomObjectVariableEnum.const_459,_loc2_.gainedExperience);
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_455,_loc2_.value);
         }
      }
   }
}

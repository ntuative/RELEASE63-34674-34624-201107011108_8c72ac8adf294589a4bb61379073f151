package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_792:Vector3d = null;
      
      private var var_793:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_325.assign(param2);
         this.var_324 = new Vector3d();
         this.var_324.assign(param3);
         this.var_792 = new Vector3d();
         this.var_792.assign(param2);
         this.var_793 = new Vector3d();
         this.var_793.assign(param3);
      ...
      {
         if(param1 != this.var_2530)
         {
            if(!param1)
            {
               this.var_325.assign(this.var_792);
               this.var_324.assign(this.var_793);
            }
            else
            {
               this.var_325.assign(this.var_792);
               this.var_325.mul(this.var_793.length / this.var_792.length);
               this.var_324.assign(this.var_793);
               this.var_324.mul(this.var_792.length / this.var_793.length);
            }
            this.var_1711 = -1;
            this.var_1505 = this.var_1505 - 1;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = Number(this.var_325.length * param1.scale);
            _loc6_ = Number(this.var_324.length * param1.scale);
            if(_loc5_ < 1)
            {
               _loc5_ = 1;
            }
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_106 == null && this.var_1226 != null || this.var_325 == null || this.var_324 == null || this._normal == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1711)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1505 || _loc4_.y != this.var_2529 || _loc4_.z != this.var_2531 || param1.scale != this.var_2014))
            {
               this.var_1505 = _loc4_.x;
               this.var_2529 = _loc4_.y;
               this.var_2531 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1226);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_177.z - _loc7_,this.var_131.z - _loc7_,this.var_99.z - _loc7_,this.var_130.z - _loc7_);
               this.var_2532 = _loc8_;

   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_348 != null)
         {
            ...
            {
               _loc1_ = this.var_348.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_348.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_348.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_1085 = this.var_348.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_1085 = null;

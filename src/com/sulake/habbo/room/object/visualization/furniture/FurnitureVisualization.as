package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2061:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2963:Number = NaN;
      ...
      private var var_2958:Number = 0.0;
      
      private var var_2962:int = -1;
      
      private var var_2960:int = -1;
      ...
      private var var_2961:Number = 0.0;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1669 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1669;
            this.var_1669 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_697 != spriteCount)
         {
            createSprites(this.var_697);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2561;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_511 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2963)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2959 = _loc3_.getNumber(RoomObjectVariableEnum.const_303);
            ...
            this.var_1385 = this.getAdClickUrl(_loc3_);
            if(this.var_1385 == null || this.var_1385.indexOf("http") != 0)
            {
               this.var_1385 = null;
            }
            this.var_2561 = this.var_1385 != null;
            this.var_2961 = _loc3_.getNumber(RoomObjectVariableEnum.const_823);
      ...
      {
         if(this.var_2960 != param2 || this.var_2958 != param1)
         {
            this.var_1114 = [];
            this.var_1115 = [];
            this.var_902 = [];
            ...
            this.var_2962 = this.getSize(param1);
      ...
      {
         this.var_697 = param1;
         this.var_1670 = this.var_697 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc3_:String = this.var_1114[param2];
         var _loc4_:Boolean = this.var_1115[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2962;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1670)
            {
      ...
      {
         if(this.var_906[param3] != null && !this.var_2164)
         {
            return this.var_906[param3];
         }
         if(this._data == null)
         {
         ...
         this.var_906[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteColor(param1:int, param2:int, param3:int) : int
      {
         if(this.var_904[param2] != null)
         {
            return this.var_904[param2];
         }
         if(this._data == null)
         {
      ...
      {
         var _loc4_:int = 0;
         if(param3 != this.var_1670)
         {
            if(this.var_905[param3] != null)
            {
         ...
         return Math.ceil(this.var_2961 * (param1 / 2));
      }

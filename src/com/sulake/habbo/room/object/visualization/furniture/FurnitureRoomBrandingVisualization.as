   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1707 = _loc4_.getNumber(RoomObjectVariableEnum.const_659);
                  this.var_1706 = _loc4_.getNumber(RoomObjectVariableEnum.const_642);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_581);
               }
            }
         }
         if(!this.var_1419)
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_364);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_609);
                     if(_loc4_ == 1)
                     {

package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_449:int = 1000;
      ...
      private var var_1506:int = 360;
      
      private var var_795:DirectionData = null;
      
      private var var_282:Map;
      
      private var _colors:Map;
      
      private var var_1228:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_795 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_282 != null)
         {
            ...
            {
               _loc2_ = this.var_282.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_795,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_282.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_795);
            this.defineDirection(_loc3_,_loc8_);
            this.var_282.add(String(_loc7_),_loc3_);
            this.var_1858 = -1;
            this.var_1228 = null;
            _loc5_++;
         }
         ...
         while(_loc4_ < param2.length())
         {
            ...
            switch(_loc8_)
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1399);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1506 / 2) % 360 / this.var_1506;
         if(this.var_282.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_282.getKey(_loc5_)) * this.var_1506;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_282.getKey(_loc4_));
         }
         return const_1745;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_282.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_795;
         }
         this.var_1858 = param1;
         this.var_1228 = _loc2_;
         return this.var_1228;
      }

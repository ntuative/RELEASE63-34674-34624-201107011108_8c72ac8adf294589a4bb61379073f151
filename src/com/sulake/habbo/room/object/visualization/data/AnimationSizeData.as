   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_345 != null)
         {
            ...
            {
               _loc2_ = this.var_345.getWithIndex(_loc1_) as AnimationData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            this.var_345.add(_loc6_,_loc9_);
            if(!_loc7_)
            {
      ...
      {
         if(this.var_345.getValue(param1) != null)
         {
            return true;
         }
         return false;
      ...
      {
         var _loc3_:AnimationData = this.var_345.getValue(param1) as AnimationData;
         if(_loc3_ != null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:AnimationData = this.var_345.getValue(param1) as AnimationData;
         if(_loc5_ != null)
         {
      ...
      {
         var _loc8_:* = null;
         var _loc7_:AnimationData = this.var_345.getValue(param1) as AnimationData;
         if(_loc7_ != null)
         {

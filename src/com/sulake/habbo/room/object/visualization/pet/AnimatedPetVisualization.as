   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2486)
            {
               this.var_2486 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_149)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_267);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_151);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_267);
            if(!isNaN(_loc6_))
            {
            ...
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_151);
            if(!isNaN(_loc7_))
            {
            ...
            this.var_2113 = _loc3_.getNumber(RoomObjectVariableEnum.const_312) > 0;
            ...
            {
               this.var_1835 = direction;
            }
            this.var_1440 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2296 = _loc3_.getNumber(RoomObjectVariableEnum.const_459);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_735);
            if(_loc9_ != this.var_1836)
            {
               this.var_1836 = _loc9_;
               this.var_2485 = this.var_1836.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_381 != null)
         {
            ...
            if(this.var_1440 > 0)
            {
               _loc2_ = param1 - this.var_1440;
               if(_loc2_ < const_1063)
               {
                  this.var_381.alpha = int(Math.sin(_loc2_ / const_1063 * 0) * 255);
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2485);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_690)
         {
            ...
            {
               if(param2 >= FurnitureVisualizationData.const_562.length)
               {
                  return null;
               }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1835);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1503)
            {
               this.var_986[param1] = true;
            }
            else
            {
               this.var_986[param1] = false;
            }
         }

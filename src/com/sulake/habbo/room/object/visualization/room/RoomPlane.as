package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1226:Vector3d = null;
      ...
      private var var_2532:Number = 0;
      
      private var _color:uint = 0;
      
      private var var_1072:IPlaneRasterizer = null;
      
      private var var_779:PlaneMaskManager = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_1226.assign(param1);
         this.var_106 = new Vector3d();
         this.var_106.assign(param2);
         this.var_325 = new Vector3d();
         this.var_325.assign(param3);
         this.var_324 = new Vector3d();
         this.var_324.assign(param4);
         this._normal = Vector3d.crossProduct(this.var_325,this.var_324);
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_704);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1072.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_484;
         if(_loc3_ == null)
         {
         ...
         if(this.var_863 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_404))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_325.length * param1.scale;
            _loc6_ = this.var_324.length * param1.scale;
            ...
            if(this.var_1072 != null)
            {
               _loc3_ = this.var_1072.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2034,this.var_2803,this.var_2805,this.var_2804,this.var_2806,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1433.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1433[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1226);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_177.z - originZ,this.var_131.z - originZ,this.var_99.z - originZ,this.var_130.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2532 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2807);
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         this.var_131.assign(param1.getScreenPosition(Vector3d.sum(this.var_106,this.var_324)));
         this.var_99.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_106,this.var_325),this.var_324)));
         this.var_130.assign(param1.getScreenPosition(Vector3d.sum(this.var_106,this.var_325)));
         this._offset = param1.getScreenPoint(this.var_1226);
         ...
         var _loc2_:Number = Math.min(this.var_177.x,this.var_131.x,this.var_99.x,this.var_130.x);
         var _loc3_:Number = Math.max(this.var_177.x,this.var_131.x,this.var_99.x,this.var_130.x);
         var _loc4_:Number = Math.min(this.var_177.y,this.var_131.y,this.var_99.y,this.var_130.y);
         var _loc5_:Number = Math.max(this.var_177.y,this.var_131.y,this.var_99.y,this.var_130.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_177 == null || this.var_131 == null || this.var_99 == null || this.var_130 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1073)
         {
            ...
            {
               _loc4_ = this.var_301[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_301.length == this.var_1074.length)
         {
            while(_loc1_ < this.var_301.length)
            {
               _loc4_ = this.var_301[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
         ...
         if(this.var_403.length > this.var_1605.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1073 || this.var_301.length == 0 && this.var_403.length == 0 && !this.var_404 || this.var_779 == null)
         {
            return;
         }
         ...
         if(this.var_404)
         {
            ...
            while(_loc5_ < this.var_301.length)
            {
               _loc3_ = this.var_301[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_325.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_324.length;
                  _loc12_ = _loc3_.type;
                  this.var_779.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < this.var_403.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_325.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_324.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_325.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_324.length;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_260.copyChannel(param1,param1.rect,const_704,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_260.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_260,this.var_260.rect,const_704,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}

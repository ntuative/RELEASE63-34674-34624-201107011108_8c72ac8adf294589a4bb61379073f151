package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_536:FloorRasterizer;
      
      private var var_780:WallAdRasterizer;
      
      private var var_534:LandscapeRasterizer;
      
      private var var_779:PlaneMaskManager;
      ...
      public function RoomVisualizationData()
      {
         ...
         this.var_536 = new FloorRasterizer();
         this.var_780 = new WallAdRasterizer();
         this.var_534 = new LandscapeRasterizer();
         this.var_779 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc8_ = _loc3_[0];
            this.var_536.initialize(_loc8_);
         }
         var _loc4_:XMLList = param1.wallAdData;
         if(_loc4_.length() > 0)
         {
            _loc9_ = _loc4_[0];
            this.var_780.initialize(_loc9_);
         }
         var _loc5_:XMLList = param1.landscapeData;
         if(_loc5_.length() > 0)
         {
            _loc10_ = _loc5_[0];
            this.var_534.initialize(_loc10_);
         }
         var _loc6_:XMLList = param1.maskData;
         if(_loc6_.length() > 0)
         {
            _loc11_ = _loc6_[0];
            this.var_779.initialize(_loc11_);
         }
         return true;
      }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         this.var_780.initializeAssetCollection(param1);
         this.var_534.initializeAssetCollection(param1);
         this.var_779.initializeAssetCollection(param1);
         this.var_765 = true;
      }

package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_907:int = 6;
      
      public static const const_1765:int = const_460;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         {
            _loc5_ = new Rectangle(0,0,this.var_32.width,this.var_623);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_32.height - this.var_623,this.var_32.width,this.var_623);
         }

package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1962:int = 16777215;
      
      public static const const_1994:int = 13421772;
      
      private static const const_1100:int = 16777215;
      
      private static const const_1097:int = 13421772;
      
      private static const const_1098:int = 10066329;
      
      private static const const_1099:int = 10066329;
      
      public static const const_1934:int = 16777215;
      
      public static const const_1916:int = 13421772;
      
      public static const const_1835:int = 10066329;
      ...
      private var var_848:Rectangle = null;
      
      private var var_569:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_998:Number = NaN;
      
      private var var_1507:Number = NaN;
      
      private var var_2779:Number = NaN;
      
      private var var_2015:String = null;
      
      private var var_1310:uint = 16777215;
      
      private var var_2776:int = 255;
      
      private var var_2777:int = 255;
      
      private var var_2778:int = 255;
      ...
      private const const_2375:int = 250;
      
      private var var_1711:int = -1;
      
      private var var_1505:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_569 = new RoomPlaneBitmapMaskParser();
         this.var_343["null"] = false;
         this.var_343["null"] = true;
         this.var_343["null"] = true;
         this.var_343["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_848 = super.boundingRectangle;
         }
         return new Rectangle(this.var_848.x,this.var_848.y,this.var_848.width,this.var_848.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_998))
         {
            this._planeParser.floorThicknessMultiplier = this.var_998;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1241);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_276)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1962;
               }
               else
               {
                  _loc13_.color = const_1994;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_402)
            {
               ...
               {
                  _loc13_.color = const_1916;
               }
               else
               {
                  _loc13_.color = const_1835;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1926)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_77,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2375 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_402.length)
            {
               _loc11_ = this.var_693[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_402[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2016)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2778 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2777 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2776 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1711)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1505 || _loc3_.y != this.var_2529 || _loc3_.z != this.var_2531 || param1.scale != this.var_2014))
            {
               this.var_1505 = _loc3_.x;
               this.var_2529 = _loc3_.y;
               this.var_2531 = _loc3_.z;
               this.var_2014 = param1.scale;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_149 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1176);
            if(_loc3_ != this.var_2015)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2015 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_768));
            if(_loc4_ != this.var_1310)
            {
               this.var_1310 = _loc4_;
               this.var_2778 = this.var_1310 & 255;
               this.var_2777 = this.var_1310 >> 8 & 255;
               this.var_2776 = this.var_1310 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1273));
            if(_loc5_ != this.var_2016)
            {
               this.var_2016 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_149 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_225);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1017));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_939));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_845));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_149 != param1.getUpdateID())
         {
            ...
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_998 || _loc3_ != this.var_1507))
            {
               this.var_998 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_149 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1201);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2779)
            {
               this.var_2779 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      {
         if(param1 != this.var_343["null"] || param2 != this.var_343["null"] || param3 != this.var_343["null"])
         {
            this.var_343["null"] = param1;
            this.var_343["null"] = param2;
            this.var_343["null"] = param3;
            this.var_402 = [];
            this.var_693 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_402;
         if(this.var_402.length == 0)
         {
            _loc6_ = this.var_162;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_402.length > 0;
         var _loc9_:int = 0;
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_343[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_402.push(_loc12_);
                        this.var_693.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1309;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_569.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_569.maskCount)
         {
            _loc10_ = this.var_569.getMaskType(_loc8_);
            _loc11_ = this.var_569.getMaskLocation(_loc8_);
            _loc12_ = this.var_569.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_77 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_245)
                              {

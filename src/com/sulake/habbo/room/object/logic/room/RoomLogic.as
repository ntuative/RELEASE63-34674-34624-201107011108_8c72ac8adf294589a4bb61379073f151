package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1453:uint = 16777215;
      
      private var var_1757:int = 255;
      
      private var var_1175:uint = 16777215;
      
      private var var_1758:int = 255;
      
      private var var_1174:int = 0;
      
      private var var_1759:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_616,RoomObjectMouseEvent.const_150];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1004,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_768,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_1017,1);
         ...
         if(this.var_1452)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_1004,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1201,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1174)
         {
            ...
            if(_loc2_ - this.var_1174 >= this.var_1759)
            {
               _loc3_ = this.var_1175;
               _loc4_ = this.var_1758;
               this.var_1174 = 0;
            }
            else
            {
               _loc7_ = this.var_1453 >> 16 & 255;
               _loc8_ = this.var_1453 >> 8 & 255;
               _loc9_ = this.var_1453 & 255;
               _loc10_ = this.var_1175 >> 16 & 255;
               _loc11_ = this.var_1175 >> 8 & 255;
               _loc12_ = this.var_1175 & 255;
               _loc13_ = (_loc2_ - this.var_1174) / this.var_1759;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1757 + (this.var_1758 - this.var_1757) * _loc13_;
               this._color = _loc3_;
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_768,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_998:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_981:
               param2.setString(RoomObjectVariableEnum.const_208,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_904:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_608:
               ...
               this.var_569.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_999:
               _loc4_ = this.var_569.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_569.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1260:
               param2.setNumber(RoomObjectVariableEnum.const_1017,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1268:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_691:
               param2.setNumber(RoomObjectVariableEnum.const_1254,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1231:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1273,int(param1.bgOnly));
         this.var_1453 = this._color;
         this.var_1757 = this.var_1756;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1727,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1879,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1799,_loc21_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_301 || _loc12_ == RoomPlaneData.const_402)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {

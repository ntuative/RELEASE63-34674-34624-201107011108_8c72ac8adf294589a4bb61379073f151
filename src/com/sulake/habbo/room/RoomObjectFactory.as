package com.sulake.habbo.room
{
   ...
   public class RoomObjectFactory extends Component implements IRoomObjectFactory
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_966.indexOf(param1) < 0)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc3_:int = this.var_966.indexOf(param1);
         if(_loc3_ >= 0)
         {
            this.var_966.splice(_loc3_,1);
            if(param1 != null)
            {
               for each(_loc2_ in this.var_1197.getKeys())
               {
      ...
      public function createRoomObjectLogic(param1:String) : IRoomObjectEventHandler
      {
         ...
         switch(param1)
         {
            ...
            case RoomObjectLogicEnum.const_1811:
               ...
               break;
            case RoomObjectLogicEnum.const_1876:
            ...
            case RoomObjectLogicEnum.const_340:
               ...
               break;
            case RoomObjectLogicEnum.const_2031:
         ...
         if(_loc3_ is IRoomObjectEventHandler)
         {
            ...
            if(this.var_1802.getValue(param1) == null)
            {
               this.var_1802.add(param1,true);

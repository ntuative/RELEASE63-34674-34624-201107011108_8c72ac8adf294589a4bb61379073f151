package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class Icon implements IDisposable
   {
      ...
      protected static const const_300:int = 18;
      ...
      {
         this.var_1214 = const_675 | const_676;
         this.var_649 = new Point();
         super();
      }
      ...
      protected function redraw() : void
      {
         ...
         if(this.var_100 && !this.var_100.disposed)
         {
            ...
            {
               this.var_649.x = this.var_649.y = 0;
               _loc1_ = this.var_46.content as BitmapData;
               switch(this.var_1214 & const_2039)
               {
                  case const_675:
                     this.var_649.x = this.var_100.bitmap.width / 2 - _loc1_.width / 2;
                     break;
                  case const_2040:
                     this.var_649.x = this.var_100.bitmap.width - _loc1_.width;
               }
               switch(this.var_1214 & const_2041)
               {
                  case const_676:
                     this.var_649.y = this.var_100.bitmap.height / 2 - _loc1_.height / 2;
                     break;
                  case const_300:
                     this.var_649.y = this.var_100.bitmap.height - _loc1_.height;
               }
               this.var_100.bitmap.copyPixels(_loc1_,_loc1_.rect,this.var_649);

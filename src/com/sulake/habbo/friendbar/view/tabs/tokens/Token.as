package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static var var_1430:IHabboWindowManager;
      
      protected static var var_1429:IAssetLibrary;
      ...
      {
         var _loc7_:* = null;
         this._window = var_1430.buildFromXML(var_1429.getAssetByName(param3).content as XML) as IWindowContainer;
         this._window.findChildByName(const_2042).caption = param1;
         this._window.findChildByName(const_1069).caption = !!param2 ? param2 : "";
         _loc7_ = var_1429.getAssetByName(param5) as BitmapDataAsset;
         if(_loc7_)
         {
            IBitmapWrapperWindow(this._window.findChildByName(ICON)).bitmap = _loc7_.content as BitmapData;
         }
         this._icon = var_1430.create("ICON_" + this.typeCode,WindowType.const_345,WindowStyle.const_103,WindowParam.const_31,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1430.create("BITMAP_" + this.typeCode,WindowType.const_447,WindowStyle.const_103,WindowParam.const_188,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
         _loc8_.disposesBitmap = false;
         _loc7_ = var_1429.getAssetByName(param4) as BitmapDataAsset;
         if(_loc7_)
         {

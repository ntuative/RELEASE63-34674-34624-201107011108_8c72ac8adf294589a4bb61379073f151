package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1485 ? var_1485 : new FriendRequestTab();
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_345,WindowStyle.const_103,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_447,WindowStyle.const_103,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case const_2038:
                  var_358.acceptFriendRequest(var_167.id);
                  break;
               case const_1416:
                  if(selected)
                  {
                  ...
                  break;
               case const_1028:
                  var_358.declineFriendRequest(var_167.id);
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == const_1028)
            {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1028)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1476;
            }
         }
      }

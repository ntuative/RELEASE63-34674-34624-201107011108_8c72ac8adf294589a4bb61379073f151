package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2052:String = "friend_requests_tab_xml";
      ...
      protected static const const_2050:String = "badge_counter";
      
      protected static const const_2051:String = "button_accept_all";
      
      protected static const const_2053:String = "click_area_discard_all";
      
      protected static const const_1416:String = "button_close";
      
      protected static const const_2038:String = "button_accept";
      
      protected static const const_1030:String = "click_area_discard";
      
      protected static const const_1410:String = "text_discard";
      
      private static var var_1485:FriendRequestsTab;
      
      private static const const_76:uint = 4294625561;
      
      private static const const_1058:uint = 4294957414;
      
      private static const const_1558:uint = 4289431312;
      
      private static const const_1557:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1476:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1485 ? var_1485 : new FriendRequestsTab();
         _loc2_.var_169 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2050).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1942)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1265.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1558) : uint(const_1557);
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2052).content as XML) as IWindowContainer;
         ...
         this.var_1265 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == const_1030)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1410)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1030)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1410)).textColor = const_1476;
            }
         }
      }

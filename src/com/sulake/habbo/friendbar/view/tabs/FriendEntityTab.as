package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1571:String = "entity_xml";
      
      private static const const_1573:String = "facebook_piece_xml";
      
      private static const const_1572:String = "controls_piece_xml";
      
      protected static const const_1033:String = "pieces";
      
      protected static const const_385:String = "icons";
      
      protected static const const_465:String = "header";
      
      protected static const const_1411:String = "facebook";
      
      protected static const const_1413:String = "controls";
      ...
      protected static const const_1032:String = "icon_message";
      ...
      protected static const const_526:String = "notification";
      
      private static const const_76:uint = 10338138;
      
      private static const const_1058:uint = 13891476;
      
      private static const const_1092:String = null;
      
      private static const const_698:String = "icon_tag_notify";
      
      private static const const_1570:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1033));
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_526,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1033));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1573).content as XML) as IWindowContainer;
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1572).content as XML) as IWindowContainer;
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1058) : uint(const_76);
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_167)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1033)).getListItemByName(const_465) as IWindowContainer;
            _loc1_.findChildByName(const_681).caption = this.var_167.name;
            var_2206.crop(_loc1_.getChildByName(const_681) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_502.getAvatarFaceBitmap(this.var_167.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_475.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1571).content as XML) as IWindowContainer;
         ...
         if(!disposed && !recycled)
         {
            switch(param1.window.name)
            {
               ...
               case const_1032:
                  ...
                  if(var_358 && this.var_167)
                  {
                     var_358.startConversation(this.var_167.id);
                     this.deselect(true);
                     if(param1.window.name == const_1032)
                     {
               ...
               case const_1412:
                  if(var_358 && this.var_167)
                  {
                     var_358.followToRoom(this.var_167.id);
                     this.deselect(true);
                  }
            }
         }
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         switch(param1.typeCode)
         {
            ...
            case FriendNotification.const_409:
               ...
               _loc4_.iconElement.name = const_1032;

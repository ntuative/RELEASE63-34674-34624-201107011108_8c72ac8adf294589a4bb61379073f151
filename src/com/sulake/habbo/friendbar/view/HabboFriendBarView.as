package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1491:int = 127;
      
      private static const const_470:int = 1;
      
      private static const const_1494:int = 2;
      
      private static const const_686:int = 3;
      
      private static const const_1060:int = 3;
      
      private static const const_1486:Boolean = false;
      
      private static const const_687:int = 3;
      
      private static const const_1480:String = "arrow";
      
      private static const const_1490:String = "left";
      
      private static const const_1485:String = "right";
      
      private static const const_1481:String = "bar_xml";
      
      private static const const_1483:String = "toggle_xml";
      
      private static const const_69:String = "container";
      
      private static const const_1059:String = "wrapper";
      
      private static const const_1479:String = "border";
      
      private static const const_688:String = "list";
      ...
      private static const const_1033:String = "pieces";
      
      private static const BUTTON_LEFT_SINGLE:String = "button_left";
      
      private static const const_1493:String = "button_right";
      
      private static const const_1477:String = "button_left_page";
      
      private static const const_1484:String = "button_right_page";
      
      private static const const_1478:String = "button_left_end";
      
      private static const const_1489:String = "button_right_end";
      
      private static const const_1416:String = "button_close";
      
      private static const const_1492:String = "button_open";
      
      private static const const_1487:String = "link_stream";
      
      private static const const_1488:String = "link_friendlist";
      
      private static const const_1482:String = "messenger";
      
      private static const const_1061:String = "friendlist";
       
      
      private var var_48:IHabboFriendBarData;
      ...
      private var var_1201:ITab;
      
      private var var_972:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1486:TextCropper;
      
      private var var_537:FriendListIcon;
      
      private var var_378:MessengerIcon;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_48)
            {
               if(!this.var_48.disposed)
               {
                  if(this.var_48.events)
                  {
                     this.var_48.events.removeEventListener(FriendBarUpdateEvent.const_732,this.onRefreshView);
                     this.var_48.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_48.events.removeEventListener(FriendRequestUpdateEvent.const_786,this.onFriendRequestUpdate);
                     this.var_48.events.removeEventListener(NewMessageEvent.const_784,this.onNewInstantMessage);
                     this.var_48.events.removeEventListener(NotificationEvent.const_868,this.onFriendNotification);
                  }
                  this.var_48.release(new IIDHabboFriendBarData());
                  this.var_48 = null;
               }
            }
            if(_windowManager)
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_216)
         {
            ...
            if(this.var_52)
            {
               this.var_216.x = this.var_52.x;
               this.var_216.y = this.var_52.y;
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_972;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_52.findChildByName(const_69) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_688) as IItemListWindow;
         ...
         var _loc6_:int = this.var_48.numFriends;
         var _loc7_:int = this.var_48.numFriendRequests;
         var _loc8_:int = this.maxNumOfTabsVisible;
         var _loc9_:int = _loc6_ + (!!this.var_1487 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(_loc7_ > 0)
         {
            if(this._startIndex == 0)
            {
               if(this.var_72.length < _loc8_)
               {
                  if(_loc7_ == 1)
                  {
                     _loc12_ = this.var_48.getFriendRequestAt(0);
                  ...
                  {
                     _loc14_ = FriendRequestsTab.allocate(this.var_48.getFriendRequestList());
                     this.var_72.push(_loc14_);
                     _loc3_.addListItem(_loc14_.window);
                  }
               }
         ...
         while(_loc5_ < _loc6_ + _loc11_)
         {
            ...
            _loc13_ = this.var_48.getFriendAt(_loc5_);
      ...
      {
         this.var_48 = param2 as IHabboFriendBarData;
         this.var_48.events.addEventListener(FriendBarUpdateEvent.const_732,this.onRefreshView);
         this.var_48.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_48.events.addEventListener(FriendRequestUpdateEvent.const_786,this.onFriendRequestUpdate);
         this.var_48.events.addEventListener(NewMessageEvent.const_784,this.onNewInstantMessage);
         this.var_48.events.addEventListener(NotificationEvent.const_868,this.onFriendNotification);
      }
      ...
      {
         var_748 = param2 as IHabboLocalizationManager;
      }
      ...
      {
         var _loc2_:* = null;
         Tab.var_358 = this.var_48;
         Tab.var_502 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2215 = var_748;
         Tab.var_2206 = this.var_1486;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1481);
         this.var_52 = _windowManager.buildFromXML(_loc1_.content as XML,const_470) as IWindowContainer;
         this.var_52.x = const_686;
         this.var_52.y = this.var_52.parent.height - (this.var_52.height + const_1494);
         this.var_52.width = this.var_52.parent.width - (const_686 + const_1060);
         this.var_52.setParamFlag(WindowParam.const_292,true);
         this.var_52.procedure = this.barWindowEventProc;
         if(const_1486)
         {
            _loc1_ = assets.getAssetByName(const_1483);
            this.var_216 = _windowManager.buildFromXML(_loc1_.content as XML,const_470) as IWindowContainer;
            this.var_216.x = this.var_52.x;
            this.var_216.y = this.var_52.y;
            this.var_216.setParamFlag(WindowParam.const_292,true);
            this.var_216.visible = false;
            this.var_216.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_52.findChildByName(const_1061));
         ...
         this.var_537 = new FriendListIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         _loc2_ = IWindowContainer(this.var_52.findChildByName(const_1482));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_378 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_378.enable(false);
         this.visible = true;
      ...
      {
         var_607 = param2 as IAvatarRenderManager;
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_607)
         {
            _loc3_ = var_607.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_52.findChildByName(const_688) as IItemListWindow;
         var _loc4_:int = this.var_48.numFriends;
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc2_ = this.var_48.getFriendAt(_loc5_);
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     _loc10_ = _loc9_.getChildByName(const_1033) as IItemListWindow;
                     if(_loc10_)
                     {
         ...
         var _loc6_:Array = this.var_48.getFriendRequestList();
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_972 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFindFriendsNotification(param1:FindFriendsNotificationEvent) : void
      {
         ...
         {
            param1.dispose();
         },HabboAlertDialogFlag.const_657);
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_537)
         {
            this.var_537.notify(this.var_48.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_378)
         {
            if(param1.notify)
            {
               this.var_378.notify(true);
            }
            else
            {
               this.var_378.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_48.numFriends + (!!this.var_1487 ? 1 : 0) + (this.var_48.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               ...
               case const_1479:
                  ...
                  break;
               case const_1488:
                  this.var_48.toggleFriendList();
                  break;
               case const_1487:
                  this.var_48.toggleOfflineStream();
            }
         ...
         if(param1.type == WindowEvent.const_496)
         {
            this.deSelect(true);
         }
      }
      ...
      {
         var _loc2_:Icon = param1.window.name == const_1061 ? this.var_537 : this.var_378;
         switch(param1.type)
         {
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_52.findChildByName(const_1059) as IWindowContainer;
         _loc5_ = [];
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1485,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
            ...
            if(this.var_52)
            {
               ...
               if(!param1)
               {
                  ...
                  else if(_loc2_ > this.var_72.length)
                  {
                     ...
                     else if(this.var_72.length < this.var_48.numFriends + (!!this.var_1487 ? 1 : 0))
                     {
                        param1 = true;
                     }
                     else if(this.numFriendEntityTabsVisible < this.var_48.numFriends)
                     {
                        param1 = true;
                     }
                  }
      ...
      {
         var _loc1_:IWindowContainer = this.var_52.findChildByName(const_69) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1059) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_688) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1491 + _loc3_.spacing);
      }

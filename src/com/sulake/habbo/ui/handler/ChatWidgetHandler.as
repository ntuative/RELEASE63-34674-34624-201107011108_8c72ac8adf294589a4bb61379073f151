package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1713:Map = null;
      
      private var var_1157:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1156:Number = 0.0;
      
      private var var_758:Point = null;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc3_ in this.var_1157)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_800,RoomWidgetChatSelectAvatarMessage.const_946];
      }
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1205))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_396);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_35) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1205))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_666);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_135:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_163:
                           this._container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_946:
      ...
      {
         return [RoomSessionChatEvent.const_233];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_233:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           _loc15_ = this._container.roomEngine.method_8(_loc3_.session.roomId,_loc3_.session.roomCategory,this._container.getFirstCanvasId());
                           if(_loc15_ != null)
                           {
                              _loc6_ += _loc15_.x;
                              _loc7_ += _loc15_.y;
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(this.var_613.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_613.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1156 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1156);
            }
            if(this.var_758 == null)
            {
               ...
               this.var_515.y = 0;
               this.var_515.z = 0;
               this.var_758 = _loc4_.getScreenPoint(this.var_515);
               this.var_1156 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_515.x = 0;
            ...
            if(_loc8_ != null)
            {
               _loc9_ = this._container.roomEngine.method_8(_loc2_,_loc3_,_loc1_);
               if(_loc9_ != null)
               {
                  _loc8_.offset(_loc9_.x,_loc9_.y);
               }
               if(_loc8_.x != this.var_758.x || _loc8_.y != this.var_758.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_758,_loc5_));
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_613.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1713.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1713.remove(param1);
         if(_loc3_ != null)
         {

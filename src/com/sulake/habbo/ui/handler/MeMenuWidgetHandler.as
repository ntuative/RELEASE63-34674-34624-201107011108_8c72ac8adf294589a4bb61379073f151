package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1610)
            {
               ...
               this.var_1610 = _loc3_;
               this.var_2045 = _loc1_;
               this.var_2046 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_2045;
               _loc2_ = this.var_2046;
            }
         }
         if(this._toolbar != null)
         {
            if(_loc1_ != null && _loc2_ != null)
            {
               if(_loc1_.height > const_479)
               {
                  ...
                  if(_loc2_.height > const_479 - const_1115)
                  {
                     _loc8_.offset(0,_loc2_.height - const_479 + const_1115);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_892);
         _loc1_.push(RoomWidgetDanceMessage.const_740);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_889);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1226);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1350);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1296);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_929);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_856);
         _loc1_.push(RoomWidgetStopEffectMessage.const_870);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1738);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1207);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_573);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1836);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1313);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_961);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_942);
         _loc1_.push(RoomWidgetMeMenuMessage.const_752);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_872);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1732);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_974);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_757);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1279);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_942:
               ...
               break;
            case RoomWidgetWaveMessage.const_892:
            ...
            case RoomWidgetGetEffectsMessage.const_889:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1226:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1350:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_856:
               ...
               break;
            case RoomWidgetOpenInventoryMessage.const_929:
               ...
               if(this.var_12 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_1818:
                        this._catalog.openCatalogPage(CatalogPageName.const_1274,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1202:
                        this.var_12.method_1(InventoryCategory.const_214);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1911:
                        this.var_12.method_1(InventoryCategory.const_78);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1857:
                        break;
                     default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1207:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_961:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetMeMenuMessage.const_752:
               ...
               break;
            case RoomWidgetAvatarEditorMessage.const_573:
               ...
               if(this._container)
               {
                  ...
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_627));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_872:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_974:
            ...
            case RoomWidgetStoreSettingsMessage.const_757:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_446,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1279:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_811:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_658));
         }
      }

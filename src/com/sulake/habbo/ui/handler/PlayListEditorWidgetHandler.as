package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1682:IMessageEvent;
      
      private var var_2186:IMessageEvent;
      
      private var var_2185:IMessageEvent;
      ...
      {
         this.var_1682 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_2186 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_2185 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1682);
         this._connection.addMessageEvent(this.var_2186);
         this._connection.addMessageEvent(this.var_2185);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1682);
               this._connection.removeMessageEvent(this.var_2186);
               this._connection.removeMessageEvent(this.var_2185);
            }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_971,RoomWidgetPlayListModificationMessage.const_874,RoomWidgetPlayListModificationMessage.const_861,RoomWidgetPlayListPlayStateMessage.const_1003,RoomWidgetPlayListUserActionMessage.const_734];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_971:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_750,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_874:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_861:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_1003:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_734:
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomEngineSoundMachineEvent.const_299);
         return _loc1_;
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_299:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_854,_loc2_.objectId);
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_832,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_897));
               break;

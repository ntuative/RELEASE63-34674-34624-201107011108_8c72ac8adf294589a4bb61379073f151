package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_930,RoomWidgetViralFurniMessage.const_769,RoomWidgetViralFurniMessage.const_191];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_930:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_653);
                     _loc8_ = "+";
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_576,RoomSessionViralFurniStatusEvent.const_522];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_576:

package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_253.events.addEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_253.events.addEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_253 != null)
         {
            this.var_253.events.removeEventListener(NowPlayingEvent.const_105,this.onNowPlayingChanged);
            this.var_253.events.removeEventListener(SongInfoReceivedEvent.const_100,this.onSongInfoReceivedEvent);
            this.var_253 = null;
         }
         this.var_1142 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_613);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_958);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_1344);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_805);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_835);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_838);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1905);
         _loc1_.push(RoomWidgetPetCommandMessage.const_524);
         _loc1_.push(RoomWidgetPetCommandMessage.const_977);
         _loc1_.push(RoomWidgetUserActionMessage.const_593);
         _loc1_.push(RoomWidgetUserActionMessage.const_304);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_924);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_304 || param1.type == RoomWidgetUserActionMessage.const_593 || param1.type == RoomWidgetUserActionMessage.const_503)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_613:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_958:
            ...
            case RoomWidgetFurniActionMessage.const_1002:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1344:
               ...
               break;
            case RoomWidgetUserActionMessage.const_304:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_805:
            ...
            case RoomWidgetGetBadgeDetailsMessage.const_835:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_838:
            ...
            case RoomWidgetUserActionMessage.const_571:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_977:
            ...
            case RoomWidgetPetCommandMessage.const_524:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_924:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_311);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_428) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_428);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_982) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1382;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_311);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1243);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1391);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_528)
                  {
                     _loc30_ = this.var_253.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_451) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_451.length);
                     _loc26_ = parseInt(_loc31_);
                     _loc29_ = "null";
                  }
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_253.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_124)
               {
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_165)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_827);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_743;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_853;
                  }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1958);
               }
               else
               {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_253 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_253.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_444,_loc2_,_loc3_,_loc4_));
         }
      }

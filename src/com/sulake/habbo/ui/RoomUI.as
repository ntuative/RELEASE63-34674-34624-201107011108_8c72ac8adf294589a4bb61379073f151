package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends ComponentContext implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_1280:IRoomWidgetFactory;
      
      private var var_399:ISessionDataManager;
      ...
      private var var_352:IAdManager;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1173:IHabboHelp;
      
      private var var_1111:IHabboModeration;
      ...
      private var var_1380:IHabboUserDefinedRoomEvents;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1173.release(new IIDHabboHelp());
            this.var_1173 = null;
         }
         ...
         {
            this.var_1111.release(new IIDHabboModeration());
            this.var_1111 = null;
         }
         ...
         if(this.var_1380)
         {
            this.var_1380.release(new IIDHabboUserDefinedRoomEvents());
            this.var_1380 = null;
         }
         this.var_1593 = null;
         ...
         if(this.var_351)
         {
            while(this.var_351.length > 0)
            {
               _loc1_ = this.var_351.getKey(0) as String;
               _loc2_ = this.var_351.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_352 != null && this.var_352.events != null)
         {
            this.var_352.events.addEventListener(InterstitialEvent.const_530,this.interstitialCompleteEventHandler);
            this.var_352.events.addEventListener(InterstitialEvent.const_514,this.adEventHandler);
            this.var_352.events.addEventListener(AdEvent.const_589,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1173 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1111 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_1111);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_15)
         {
            this.var_15.events.addEventListener(RoomSessionEvent.const_308,this.roomSessionStateEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_233,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionChatEvent.const_558,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionPresentEvent.const_382,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_577,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionPetPackageEvent.const_559,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_576,this.roomSessionEventHandler);
            this.var_15.events.addEventListener(RoomSessionViralFurniStatusEvent.const_522,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_947,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1334,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_1180,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_906,this.roomSessionDialogEventHandler);
            this.var_15.events.addEventListener(RoomSessionErrorMessageEvent.const_965,this.roomSessionDialogEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionQueueEvent.const_548,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDimmerPresetsEvent.const_518,this.roomSessionEventHandler);
            ...
            this.var_15.events.addEventListener(RoomSessionDanceEvent.const_147,this.roomSessionEventHandler);
         }
      }
      ...
      private function roomSessionStateEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_72:
               this._toolbar.setToolbarState(HabboToolbarEnum.const_864);
               break;
            case RoomSessionEvent.const_86:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.setToolbarState(HabboToolbarEnum.const_758);
               }
         }
      }
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_298:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_906:
               errorMessage = "${room.error.pets.forbidden_in_hotel}";
               break;
            case RoomSessionErrorMessageEvent.const_965:
               errorMessage = "${room.error.pets.forbidden_in_flat}";
               break;
            case RoomSessionErrorMessageEvent.const_1024:
      ...
      private function interstitialCompleteEventHandler(param1:InterstitialEvent) : void
      {
         ...
         var _loc2_:String = this.getRoomIdentifier(this.var_2929,this.var_2930);
      ...
      private function onUserDefinedRoomEventsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1380 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_900,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_193,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_383,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_667,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_555,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_67,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_928,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_841,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_435,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_650,this.roomObjectEventHandler);
            ...
            this._roomEngine.events.addEventListener(RoomEngineSoundMachineEvent.const_299,this.roomObjectEventHandler);
         }
      }
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_900)
         {
            if(this.var_15 != null)
            {
               this.var_15.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_555 || param1.type == RoomEngineEvent.const_667)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_193:
               ...
               _loc3_.disposeWidget(RoomWidgetEnum.const_605);
               ...
               _loc3_.createWidget(RoomWidgetEnum.const_901);
               ...
               if(this.var_2147 != RoomDesktop.const_1000)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_333,this.var_2147);
               }
               if(this.var_352 != null)
               {
                  this.var_352.showRoomAd(param1.roomId,param1.roomCategory);
               }
               _loc3_.createWidget(RoomWidgetEnum.const_519);
               _loc3_.createWidget(RoomWidgetEnum.const_654);
               break;
            case RoomEngineEvent.const_383:
               this.disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_928:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_1280;
         _loc3_.sessionDataManager = this.var_399;
         _loc3_.roomSessionManager = this.var_15;
         _loc3_.friendList = this._friendList;
         _loc3_.avatarRenderManager = this.var_951;
         _loc3_.inventory = this.var_12;
         _loc3_.toolbar = this._toolbar;
         _loc3_.navigator = this._navigator;
         _loc3_.avatarEditor = this.var_1593;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_352;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_1173;
         _loc3_.moderation = this.var_1111;
         _loc3_.config = this._config;
         _loc3_.soundManager = this._soundManager;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_1380;
         ...
         if(_loc3_.showInterstitial())
         {
            ...
            this.var_2929 = param1.roomId;
            this.var_2930 = param1.roomCategory;
         }
         else
         {
            this._interstitialActive = false;
         }
         this.var_351.add(_loc2_,_loc3_);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = this.var_351.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_333);
            if(_loc3_ != RoomDesktop.const_1000)
            {
      ...
      {
         return this.var_351.getValue(param1) as RoomDesktop;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_351.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }

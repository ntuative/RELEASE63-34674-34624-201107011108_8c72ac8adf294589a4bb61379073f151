package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      public function updateSettings(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_991 != null)
         {
            this.var_991.setValue(this.var_990);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_992 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_994 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_on_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_993 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_872));
      }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_990 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_993);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_992);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_994);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_989);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_974);
         }
         else
         {

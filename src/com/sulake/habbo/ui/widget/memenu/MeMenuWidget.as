package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_513:String = "me_menu_my_clothes_view";
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2518 = param6.getBoolean("client.news.embed.enabled",false);
         }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_964,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_850,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_925,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1345,this.onAvatarEditorClosed);
         ...
         param1.addEventListener(RoomWidgetHabboClubUpdateEvent.const_288,this.onHabboClubEvent);
         ...
         param1.addEventListener(RoomWidgetTutorialEvent.const_658,this.onTutorialEvent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_964,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_850,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_925,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_166,this.onAvatarDeselected);
         param1.removeEventListener(RoomWidgetHabboClubUpdateEvent.const_288,this.onHabboClubEvent);
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1345,this.onHideAvatarEditor);
         ...
         param1.removeEventListener(RoomWidgetTutorialEvent.const_658,this.onTutorialEvent);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_542 && this.var_53.window.name == const_513))
         {
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_890)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_658:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_542 + " view: " + this.var_53.window.name);
               if(this.var_542 != true || this.var_53.window.name != const_189)
               {
                  return;
               }
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_542)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_752);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_513)
         {
            this.hide();
         }
      }
      ...
      private function onHabboClubEvent(param1:RoomWidgetHabboClubUpdateEvent) : void
      {
         ...
         this.var_2514 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1848);
         this.var_1848 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         this.var_2515 = param1.balance;
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2515.toString());
      }

package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2073:String = "infostand_pet_view";
      
      private const const_2076:String = "infostand_bot_view";
      
      private const const_2071:String = "infostand_jukebox_view";
      
      private const const_2074:String = "infostand_songdisk_view";
      
      private var var_1204:InfoStandFurniView;
      ...
      private var var_978:InfoStandJukeboxView;
      
      private var var_979:InfoStandSongDiskView;
      
      private var var_2461:Array;
      
      private var var_1490:InfostandUserData;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1204 = new InfoStandFurniView(this,this.const_2072,this._catalog);
         this.var_194 = new InfoStandUserView(this,this.const_2075);
         this.var_380 = new InfoStandPetView(this,this.const_2073,this._catalog);
         this.var_445 = new InfoStandBotView(this,this.const_2076);
         this.var_978 = new InfoStandJukeboxView(this,this.const_2071,this._catalog);
         this.var_979 = new InfoStandSongDiskView(this,this.const_2074,this._catalog);
         this.var_1490 = new InfostandUserData();
         this.var_655 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_176 = new Timer(this.const_2349);
      ...
      public function get mainContainer() : IWindowContainer
      {
         ...
         {
            this._mainContainer = windowManager.createWindow("infostand_main_container","",HabboWindowType.const_69,HabboWindowStyle.const_47,HabboWindowParam.const_47,new Rectangle(0,0,50,100)) as IWindowContainer;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_324,this.onRoomObjectSelected);
         ...
         param1.addEventListener(RoomWidgetSongUpdateEvent.const_444,this.onSongUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_324,this.onRoomObjectSelected);
         ...
         param1.removeEventListener(RoomWidgetSongUpdateEvent.const_444,this.onSongUpdate);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_304,this.var_380.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_528)
         {
            this.var_978.update(param1);
            this.selectView(this.const_2071);
         }
         else if(param1.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_451) != -1)
         {
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_194.setTags(param1.tags,this.var_2461);
         }
      }
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_613,param1.id,param1.category);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_182:
               ...
               {
                  _loc2_ = param1.id == this.var_1490.userRoomId;
                  break;
               }
      ...
      {
         this.var_978.updateSongInfo(param1);

package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1630:int = 162;
      
      private static const const_1626:int = 16;
      
      private static const const_703:int = 4;
      
      private static const const_1636:uint = 14342874;
      
      private static const const_1625:uint = 3815994;
      
      private static const const_1635:uint = 2085362;
      
      private static const const_1633:uint = 39616;
      
      private static const const_1634:uint = 10513106;
      
      private static const const_1629:uint = 8734654;
      
      private static const const_1632:uint = 9094430;
      
      private static const const_1637:uint = 6200576;
      
      private static const const_1628:String = "happiness";
      
      private static const const_1631:String = "experience";
      
      private static const const_1627:String = "energy";
      
      private static const const_1624:int = 250;
      
      private static const const_1113:int = 25;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1628,param1.nutrition,param1.nutritionMax,const_1633,const_1635);
         this.updateStateElement(const_1631,param1.experience,param1.experienceMax,const_1629,const_1634);
         this.updateStateElement(const_1627,param1.energy,param1.energyMax,const_1637,const_1632);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1630,const_1626,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1636);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1625);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_703,_loc7_.width - 2,_loc7_.height - 2 - const_703);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_703);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_530) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_227 && this.var_227.getPetId() == this.var_530)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1873,true);
      ...
      private function arrangeButtons() : void
      {
         ...
         this.var_108.height = _loc4_ + const_1113;
         this.updateWindow();
      }
   }
}

package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1171:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1170 = 0;
         this.var_1171 = param2.rectangle.clone();
         this.var_1171.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1171.width)
         {
            return false;
         }
         if(this.var_1170 + param1.height > this.var_1171.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1171.width)
         {
            this._offsetX = 0;
            this.var_1170 += param1.height + this.const_2342;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1170);
      ...
      {
         var _loc2_:* = null;
         if(this.var_1544 != null && this.var_1544.indexOf(param1) != -1)
         {

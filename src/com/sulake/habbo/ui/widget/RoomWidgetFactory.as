      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_395:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_77,this.var_154,this.var_3029++,this);
               break;
            case RoomWidgetEnum.const_352:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_77,this.var_154,this);
               break;
            case RoomWidgetEnum.const_584:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_77,this.var_154,this._catalog);
               break;
            case RoomWidgetEnum.const_542:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_77,events,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_495:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_77,this.var_154,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_511:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_77,this.var_154);
               break;
            case RoomWidgetEnum.const_605:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_77,this.var_154);
               break;
            case RoomWidgetEnum.const_121:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_77,this.var_154);
               break;
            ...
            case RoomWidgetEnum.const_130:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_154,this.var_77,this);
               break;
            ...
            case RoomWidgetEnum.const_519:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_77,this.var_154,this._catalog);
               break;

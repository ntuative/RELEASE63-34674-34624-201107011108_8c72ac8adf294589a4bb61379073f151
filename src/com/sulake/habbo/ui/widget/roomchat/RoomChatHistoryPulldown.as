package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1117:int = 150;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_43 = param3;
         this.var_2831 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_2057 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2832 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_2056 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_2058 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2833 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2834 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_88 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_361,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param3.width,param3.height - const_92),null,0,0) as IBitmapWrapperWindow;
         this.var_43.addChild(this.var_88);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_69,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_43.height - const_92,param3.width,const_92),null,0) as IWindowContainer;
         this.var_43.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_345,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_92),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_671:
               this.var_88.blend += param1 / const_1116;
               ...
               break;
            case const_1118:
               this.var_88.blend -= param1 / const_1117;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_43.width - this.var_2830;
         }
         if(this.var_88 != null)
         {
            this.var_88.rectangle = this.var_43.rectangle;
            this.var_88.height -= const_92;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2835 == this._window.width)
         {
            return;
         }
         this.var_2835 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2832;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_2056;
            barX.disposesBitmap = false;
            this.var_2830 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2831,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2057,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2057,destGripRBitmap);
         ...
         this.var_88.bitmap = this.var_2834;

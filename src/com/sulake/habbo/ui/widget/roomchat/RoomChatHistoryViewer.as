package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1689:int = 18;
      
      private static const SCROLLBAR_WIDTH:int = 20;
      
      public static const const_1225:int = 3;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_206.state = RoomChatHistoryPulldown.const_284;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1272,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_206.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_284);
      }
      ...
      {
         return !!this.var_498 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_206.state == RoomChatHistoryPulldown.const_450 || this.var_206.state == RoomChatHistoryPulldown.const_671;
      }
      ...
      {
         if(!this.var_498 && !this.var_1834)
         {
            this.var_498 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_206.state = RoomChatHistoryPulldown.const_450;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_732;
            }
         }
         if(this.var_206 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_497 > 0 && param2)
         {
            if(this.var_2166)
            {
               if(Math.abs(param1 - this.var_497) <= const_1225)
               {
                  return;
               }
               this.var_2166 = false;
            ...
            if(this.var_498)
            {
               ...
               _loc5_ = (param1 - this.var_497) / this.var_54.height;
               _loc3_ = this.var_732 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - this.var_497;
               _loc7_ = true;
               _loc8_ = true;
               if(this.var_54.scrollV < 1 - const_1689 / this.var_54.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || this.var_2165)
               {
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_732 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_732 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }

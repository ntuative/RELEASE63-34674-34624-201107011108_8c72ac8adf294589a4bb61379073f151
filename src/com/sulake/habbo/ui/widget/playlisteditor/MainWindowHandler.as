package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MainWindowHandler
   {
      ...
      private static const const_1565:int = 6;
      
      private static const const_1564:int = 9;
      
      private static const const_1566:int = 5;
      ...
      private var var_562:MusicInventoryGridView;
      
      private var var_824:PlayListEditorItemListView;
      
      private var var_252:MusicInventoryStatusView;
      
      private var var_340:PlayListStatusView;
      
      private var var_1951:IScrollbarWindow;
      ...
      public function MainWindowHandler(param1:PlayListEditorWidget, param2:IHabboMusicController)
      {
         ...
         this._widget = param1;
         this.var_253 = param2;
         var _loc3_:Array = [PlayListEditorWidgetAssetsEnum.const_736,PlayListEditorWidgetAssetsEnum.const_879,PlayListEditorWidgetAssetsEnum.const_563,PlayListEditorWidgetAssetsEnum.const_569,PlayListEditorWidgetAssetsEnum.const_957];
         ...
         this.createWindow();
         this.var_562 = new MusicInventoryGridView(param1,this.getMusicInventoryGrid(),param2);
         this.var_824 = new PlayListEditorItemListView(param1,this.getPlayListEditorItemList());
         this.var_252 = new MusicInventoryStatusView(param1,this.getMusicInventoryStatusContainer());
         this.var_340 = new PlayListStatusView(param1,this.getPlayListStatusContainer());
      ...
      public function destroy() : void
      {
         if(this.var_253)
         {
            this.var_253.stop(HabboMusicPrioritiesEnum.const_434);
            this.var_253 = null;
         }
         if(this.var_562)
         {
            this.var_562.destroy();
            this.var_562 = null;
         }
         if(this.var_824)
         {
      ...
      {
         this.var_253.requestUserSongDisks();
         var _loc1_:IPlayListController = this.var_253.getRoomItemPlaylist();
         if(_loc1_ != null)
         {
      ...
      public function refreshLoadableAsset(param1:String = "") : void
      {
         ...
         {
            this.assignWindowBitmapByAsset(this.var_1023,"music_inventory_splash_image",PlayListEditorWidgetAssetsEnum.const_736);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_879)
         {
            this.assignWindowBitmapByAsset(this.var_1022,"playlist_editor_splash_image",PlayListEditorWidgetAssetsEnum.const_879);
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_563)
         {
            this.var_252.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_563));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_569)
         {
            this.var_252.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_569));
         }
         if(param1 == "" || param1 == PlayListEditorWidgetAssetsEnum.const_957)
         {
            this.var_340.addSongsBackgroundImage = this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_957);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1023 = _loc2_.getChildByName("my_music_border") as IBorderWindow;
         this.var_1022 = _loc2_.getChildByName("playlist_border") as IBorderWindow;
         ...
         this.var_1951 = this.var_1023.getChildByName("music_inventory_scrollbar") as IScrollbarWindow;
         this.var_1952 = this.var_1022.getChildByName("playlist_scrollbar") as IScrollbarWindow;
      ...
      {
         return this.var_1023.getChildByName("music_inventory_itemgrid") as IItemGridWindow;
      }
      
      private function getPlayListEditorItemList() : IItemListWindow
      {
         return this.var_1022.getChildByName("playlist_editor_itemlist") as IItemListWindow;
      }
      
      private function getMusicInventoryStatusContainer() : IWindowContainer
      {
         return this.var_1023.getChildByName("preview_play_container") as IWindowContainer;
      }
      
      private function getPlayListStatusContainer() : IWindowContainer
      {
         return this.var_1022.getChildByName("now_playing_container") as IWindowContainer;
      }
      ...
      private function selectPlayListStatusViewByFurniPlayListState() : void
      {
         ...
         if(_loc1_.isPlaying)
         {
            this.var_340.selectView(PlayListStatusView.const_538);
         }
         else if(_loc1_.length > 0)
         {
            this.var_340.selectView(PlayListStatusView.const_1216);
         }
         else
         {
            this.var_340.selectView(PlayListStatusView.const_919);
         }
      }
      ...
      private function selectMusicStatusViewByMusicState() : void
      {
         ...
         {
            this.var_252.show();
            this.var_252.selectView(MusicInventoryStatusView.const_830);
         }
         else if(this.var_253.getSongDiskInventorySize() <= const_1565)
         {
            this.var_252.show();
            this.var_252.selectView(MusicInventoryStatusView.const_825);
         }
         else
         {
            this.var_252.hide();
      ...
      public function onPlayListUpdated() : void
      {
         ...
         if(_loc2_ != -1)
         {
            _loc3_ = this.var_253.getSongInfo(_loc2_);
            this.var_340.nowPlayingTrackName = _loc3_.name;
            this.var_340.nowPlayingAuthorName = _loc3_.creator;
         }
         this.var_1952.visible = _loc1_.length > const_1566;
      }
      
      public function onSongDiskInventoryReceived() : void
      {
         this.var_562.refresh();
         this.selectMusicStatusViewByMusicState();
         this.var_1951.visible = this.var_562.itemCount > const_1564;
      }
      ...
      public function onNowPlayingChanged(param1:RoomWidgetPlayListEditorNowPlayingEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetPlayListEditorNowPlayingEvent.const_105:
               ...
               if(param1.id != -1)
               {
                  _loc3_ = this.var_253.getSongInfo(param1.id);
                  this.var_340.nowPlayingTrackName = _loc3_ != null ? _loc3_.name : "";
                  this.var_340.nowPlayingAuthorName = _loc3_ != null ? _loc3_.creator : "";
               }
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_133:
               this.var_562.setPreviewIconToPause();
               _loc2_ = this.var_253.getSongInfo(param1.id);
               this.var_252.songName = _loc2_ != null ? _loc2_.name : "";
               this.var_252.songName = _loc2_ != null ? _loc2_.name : "";
               this.var_252.authorName = _loc2_ != null ? _loc2_.creator : "";
               this.selectMusicStatusViewByMusicState();
               break;
            case RoomWidgetPlayListEditorNowPlayingEvent.const_127:
               this.var_562.setPreviewIconToPlay();
               this.selectMusicStatusViewByMusicState();
         }
      }
      ...
      {
         return this.var_253.getSongIdPlayingAtPriority(HabboMusicPrioritiesEnum.const_434) != -1;
      }
   }
}

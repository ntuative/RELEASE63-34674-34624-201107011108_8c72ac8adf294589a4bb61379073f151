package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_830:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_2171:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_436.getValues())
         {
            _loc1_.destroy();
         }
         this.var_436 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_436[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      
      public function set songName(param1:String) : void
      {
         if(this.var_2171 == null)
         {
            return;
         }
         this.var_2171.text = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_2170.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_830,"preview_play_background_image",param1);
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_436.add(const_830,_loc1_);
            this.var_2171 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_2170 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_563));
         ...
         if(_loc1_ != null)
         {
            this.var_436.add(const_825,_loc1_);
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_436[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }

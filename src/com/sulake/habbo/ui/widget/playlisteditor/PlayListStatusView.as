package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_919:String = "PLSV_ADD_SONGS";
      ...
      {
         if(this.var_53 != const_538)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_436[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_436[const_919];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_436.add(const_538,_loc1_);

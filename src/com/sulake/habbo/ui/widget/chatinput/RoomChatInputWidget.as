package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase
   {
      ...
      private static const const_1646:int = 5000;
      ...
      {
         return getTimer() - this.var_2829 > const_1646;
      }
      
      public function setLastPasteTime() : void
      {
         this.var_2829 = getTimer();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputContentUpdateEvent.const_852,this.onChatInputUpdate);
         param1.addEventListener(RoomWidgetUserInfoUpdateEvent.const_165,this.onUserInfo);
         param1.addEventListener(RoomWidgetFloodControlEvent.const_986,this.onFloodControl);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputContentUpdateEvent.const_852,this.onChatInputUpdate);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_165,this.onUserInfo);
         param1.removeEventListener(RoomWidgetFloodControlEvent.const_986,this.onFloodControl);
      }
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_1331:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1786:
         }
      }

package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2084:int = 0;
      ...
      private const const_2085:int = 4;
      
      private const const_2363:int = 0;
      
      private const const_2364:int = 1;
      
      private const const_2362:int = 2;
      ...
      private const const_2366:String = "%campaign%_dialog_bg.png";
      
      private const const_389:String = "%campaign%_gift_package.png";
      
      private const const_2361:String = "%campaign%_gift_content.png";
      
      private const const_2360:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1554 = this.var_154.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1554 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1557.length)
         {
            _loc2_ = this.var_1557.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_154 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_653,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_653,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_653:
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_976:
               ...
               this._shareId = null;
               this.var_1555 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1556 != _loc2_ || _loc3_ != this.var_198))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1556)
            {
               ...
               case this.const_2081:
                  if(this.var_432 == this.const_2363)
                  {
                  ...
                  else if(this.var_432 == this.const_2364)
                  {
                     ...
                     _loc2_ = this.const_2361;
                  }
                  else if(this.var_432 == this.const_2362)
                  {
                  ...
                  else if(this.var_432 == this.const_2365)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_432 == this.const_2367)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_198,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_432 == this.const_2368)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2366.replace("%campaign%",this.var_198);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1555 != 0)
            {
               this.var_12.method_1(this.var_1555 == 1 ? "null" : InventoryCategory.const_136);
            }
         }
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1557.push(new ImageDownloader(this,_assets,this.var_198,this.var_1554,param1,param2));
            return;
         }

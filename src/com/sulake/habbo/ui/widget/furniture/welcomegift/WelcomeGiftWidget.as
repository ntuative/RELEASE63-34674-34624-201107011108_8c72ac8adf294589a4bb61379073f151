package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_721:String = "welcome_gift_email_unverified";
      
      private const const_1140:String = "welcome_gift_email_verified";
      
      private const const_1696:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1390)
         {
            this.setViewState(this.const_1140);
         }
         else
         {
            this.setViewState(this.const_721);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_721:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1116;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1116);
               break;
            ...
            case this.const_1696:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1116);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1675;
               _loc6_.focus();
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_922,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1390 ? this.const_1140 : this.const_721);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1674 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1674));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_747,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_747,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_500:
               this.var_1675 = param1.email;
               this.var_1390 = param1.isVerified;
               this.var_1116 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1675 = this.var_1674;
            this.setViewState(this.const_721);
         }
         else
         {
            if(param1.result == this.const_2379)
            {
               this.var_1116 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1674);

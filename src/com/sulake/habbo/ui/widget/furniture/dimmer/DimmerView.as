package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_69,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1431,const_1430,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1535 = _loc2_.light;
         if(this.var_458 != null)
         {
            this.var_458.setValue(this.var_1535);
         }
         this.var_520 = this.colors.indexOf(_loc2_.color);
         if(this.var_672 != null)
         {
            this.var_672.setSelectedColorIndex(this.var_520);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1534 = XML(_loc1_.content);
         return this.var_1534;
      }

   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in this.colors)
         {
            ...
            _loc3_.width = this.var_692.width;
            _loc3_.height = this.var_692.height;
            this.var_568.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_692.width,this.var_692.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_692,this.var_692.rect,new Point(0,0));
            }
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_1053.width,this.var_1053.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_1053,this.var_1053.rect,new Point(0,0),null,null,true);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_692 = BitmapData(_loc3_.content);
         ...
         this.var_1053 = BitmapData(_loc3_.content);
      }

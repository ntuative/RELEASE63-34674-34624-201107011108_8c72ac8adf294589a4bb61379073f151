package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_689:String = "room_view";
      
      private static const const_1499:String = "room_widget";
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_352)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1499) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_98.getChildByTag(const_689) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_98.findChildByTag(const_689) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }

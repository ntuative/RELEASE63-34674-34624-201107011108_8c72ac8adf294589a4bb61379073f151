package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_563:IKeyExchange;
      
      private var var_1024:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2664:PseudoRandom;
      ...
      private var var_254:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_675 = param1;
            this.var_64.initConnection(HabboConnectionType.const_293);
         }
      }
      ...
      {
         if(this.var_64 && this.var_154 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_254 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_254.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_154.getKey("use.sso.ticket") == "1";
         this.var_675 = this.var_154.getKey("sso.ticket",null);
         this.var_1953 = this.var_154.getKey("flash.client.url","");
         this.var_2666 = this.var_154.getKey("external.variables.txt","");
         if(this.var_254 == null)
         {
            this.var_254 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_64.mode = HabboConnectionType.const_99;
            if(this.var_675)
            {
               this.var_64.initConnection(HabboConnectionType.const_293);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_787,this.onInitConnection);
            }
            else
            {
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_64.mode = HabboConnectionType.const_1218;
            }
         }
         this.var_64.initConnection(HabboConnectionType.const_293);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_778);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2664 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_64.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_1546 = _loc4_;
               this.var_254.loadBannerImage(_loc7_ + "?token=" + this.var_1546,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1218:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1846:
               this.var_1024 = this.generateRandomHexString(30);
               this.var_563 = new DiffieHellman(new BigInteger(this.var_154.getKey("connection.development.prime"),16),new BigInteger(this.var_154.getKey("connection.development.generator"),16));
               this.var_563.init(this.var_1024);
               _loc8_ = this.var_563.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_563.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_563.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2664);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1953,this.var_2666));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2079,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2665)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1546);
         ...
         this.var_563 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_563.init(_loc14_);
            _loc15_ = this.var_563.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_1024 = _loc14_;
            }

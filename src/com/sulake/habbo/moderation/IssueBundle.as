package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_820:IssueMessageData = null;
      
      private var var_821:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2657 = param2.pickerUserId;
         this.var_2656 = param2.pickerUserName;
         this.var_1571 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_820 == null || param1.timeStamp < this.var_820.timeStamp)
         {
            this.var_820 = param1;
         }
         if(this.var_821 == null || param1.priority > this.var_821.timeStamp)
         {
            this.var_821 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(this.var_820 == _loc2_)
            {
               this.var_820 = null;
            }
            if(this.var_821 == _loc2_)
            {
               this.var_821 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_821;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_820;
         if(_loc2_ == null)
         {

package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_590:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_590 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_1381 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
         this.var_590.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1381.load(_loc4_,this.var_188.reportedUserId);
         }
         else
         {
      ...
      {
         if(this.var_76 != null && this.var_76.issueManager != null && this.var_188 != null)
         {
            this.var_76.issueManager.removeHandler(this.var_188.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_188.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_188.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.closeBundle(this.var_188.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.issueManager.releaseBundle(this.var_188.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_76.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_76,WindowTracker.const_1336,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_590 = new UserInfoCtrl(this._window,this.var_76,_loc3_.message);
            this.var_590.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }

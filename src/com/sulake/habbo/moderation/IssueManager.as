package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_996:String = "issue_bundle_my";
      
      public static const const_1362:String = "issue_bundle_picked";
      
      public static const const_1750:int = 15000;
       
      
      private var var_76:ModerationManager;
      
      private var var_742:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_742 = new IssueBrowser(this,this.var_76.windowManager,this.var_76.assets);
         this.var_1398 = [];
         this.var_1397 = [];
         this.var_1127 = new Map();
         this.var_3015 = parseInt(this.var_76.configuration.getKey("chf.score.updatefactor","60"));
         this.var_2194 = new Timer(const_1750,0);
         this.var_2194.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_2194.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1398 = this.var_1398.concat(_loc4_.getIssueIds());
      }
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1397 = this.var_1397.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_742 == null || !this.var_742.isOpen())
         {
            this.var_76.soundManager.playSound(HabboSoundTypesEnum.const_1370);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_1126.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_1126.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1803)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_124)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_1126.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_3014++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_1126.add(param1.issueId,_loc2_);
         ...
         if(this.var_1398.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_996);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1397.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_3015);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_1127.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_1127.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_1126.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_124.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_1127.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_1127.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }

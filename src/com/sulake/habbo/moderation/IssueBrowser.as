package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2352:String = "my_issues";
      
      private const const_2351:String = "open_issues";
      
      private const const_2350:String = "picked_issues";
      ...
      private var var_383:IIssueBrowserView;
      
      private var var_1872:IIssueBrowserView;
      
      private var var_1870:IIssueBrowserView;
      
      private var var_1871:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_383 == _loc2_)
         {
            return;
         }
         if(this.var_383 != null)
         {
            this.var_383.visible = false;
         }
         this.var_383 = _loc2_;
         if(this.var_383 == null)
         {
         ...
         this.var_383.view.width = this.var_284.container.width;
         this.var_383.view.height = this.var_284.container.height;
         this.var_383.visible = true;
         this.var_383.update();
      }
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2352:
               if(this.var_1872 == null)
               {
                  this.var_1872 = new MyIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1872;
            case this.const_2351:
               if(this.var_1870 == null)
               {
                  this.var_1870 = new OpenIssuesView(this.issueManager,this,this.var_284.container);
               }
               return this.var_1870;
            case this.const_2350:
               if(this.var_1871 == null)
               {
                  this.var_1871 = new PickedIssuesView(this.issueManager,this,this.var_284.container);
               }

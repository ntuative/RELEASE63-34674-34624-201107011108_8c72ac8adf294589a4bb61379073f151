package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1125:Array = [];
      
      private static var var_2189:int = 1000;
      
      private static var var_1124:Array = [];
      
      private static var var_2187:int = 200;
      ...
      private var var_1869:IMessageComposer;
      ...
      {
         this.var_917 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_916 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_528 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1869);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1125.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_916.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1125.length < var_2189)
         {
            ...
            param1.width = this.var_916.width;
            param1.height = this.var_916.height;
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1124.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_917.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1124.length < var_2187)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_917.width;
            param1.height = this.var_917.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_2188[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));

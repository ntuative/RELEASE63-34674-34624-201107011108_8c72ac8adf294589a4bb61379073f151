package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1097:Array = [];
      
      private static var var_2135:int = 200;
      ...
      {
         this.var_890 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1097.pop() as IWindowContainer;
         }

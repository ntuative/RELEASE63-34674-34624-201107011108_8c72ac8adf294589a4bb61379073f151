package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_910:int = 4;
      
      public static const const_1209:int = 5;
      
      public static const const_1757:int = 6;
      
      public static const const_1921:int = 7;
      ...
      {
         var _loc2_:Dictionary = this.var_1857[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            this.var_1857[param1] = _loc2_;
         }
         return _loc2_;
      }
   }

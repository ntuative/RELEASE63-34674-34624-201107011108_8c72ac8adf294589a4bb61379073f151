package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1080:int = 86400;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_1081) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_1080) + " days ago";
         }
      ...
      public function refresh() : void
      {
         ...
         this.method_5(_loc1_,"abusive_cfh_count_txt",this._data.abusiveCfhCount,false);
         this.method_5(_loc1_,"caution_count_txt",this._data.cautionCount,true);
         this.method_5(_loc1_,"ban_count_txt",this._data.banCount,true);
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1256.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1256.addChild(_loc1_);
      ...
      private function method_5(param1:IWindowContainer, param2:String, param3:int, param4:Boolean) : void
      {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1209,this._data.userId),this._callerFrame,this.var_1255,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1255,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1518),this._callerFrame,this.var_1255,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1518),this._callerFrame,this.var_1255,false,true);
      }

package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_715:Boolean = true;
      
      private var var_1089:ICheckBoxWindow;
      
      private var var_1631:ICheckBoxWindow;
      
      private var var_1632:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_420));
         Logger.log("BEGINNING TO SHOW: " + this.var_420);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_420);
         if(param1.flatId != this.var_420)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_420);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_1089 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1631 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1632 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_910,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_715 || this.var_549.text == "")
         {
            this.var_36.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_1089.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1810,_loc2_,this.var_549.text,"",""));
         if(this.var_1631.isSelected || this.var_1632.isSelected || this.var_1089.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1631.isSelected,this.var_1632.isSelected,this.var_1089.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1953);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1904);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1338.selection];
         if(_loc3_ != null)
         {
            this.var_715 = false;

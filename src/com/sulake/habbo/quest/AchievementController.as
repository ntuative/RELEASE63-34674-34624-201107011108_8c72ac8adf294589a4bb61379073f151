package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1617:int = 8;
      
      private static const const_1613:int = 5;
      
      private static const const_1616:int = 6;
      
      private static const const_1614:int = 3;
      
      private static const const_1608:int = 2;
      
      private static const const_1105:int = 6;
      
      private static const const_1611:int = 180;
      
      private static const const_1612:int = 246;
      
      private static const const_1440:int = 45;
      
      private static const const_1615:Point = new Point(115,93);
      
      private static const const_1619:Point = new Point(72,1);
      
      private static const const_1106:int = 40;
      
      private static const const_1618:int = 20;
      
      private static const const_1610:int = 3;
      
      private static const const_1609:int = 10;
      ...
      private var var_480:IWindowContainer;
      ...
      private var var_695:ProgressBar;
      
      private var var_857:ProgressBar;
      
      private var var_1315:Matrix;
      
      private var var_2024:ColorMatrixFilter;
      
      private var var_1602:AchievementData;
      
      private var var_856:Timer;
      
      private var var_696:Dictionary;
      
      private var var_855:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         super();
         this.var_49 = param1;
         this.var_570 = new Timer(100,1);
         this.var_570.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_856 = new Timer(2000,1);
         this.var_856.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_855 = new AchievementLevelUp(this.var_49);
         this.var_1315 = new Matrix();
         this.var_2024 = this.createGrayscaleFilter();
         this.var_696[16] = 1;
         this.var_696[28] = 6;
         this.var_696[38] = 4;
         this.var_696[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_570)
         {
            this.var_570.removeEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
            this.var_570.reset();
            this.var_570 = null;
         }
         if(this.var_856)
         {
            this.var_856.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_856.reset();
            this.var_856 = null;
         }
         if(this.var_695)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1440;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_480.height = getLowestPoint(this.var_480);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_857.refresh(this.var_118.getProgress(),this.var_118.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_854.height = getLowestPoint(this.var_854);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_1064.findChildByName("category_name_txt").caption = this.var_49.getAchievementCategoryName(this._category.code);
         ...
         this.var_49.setupAchievementCategoryImage(this.var_1064,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_481.findChildByName("achievement_name_txt").caption = this.var_49.localization.getBadgeName(_loc1_);
         ...
         this.var_49.localization.registerParameter("achievements.details.level","level","" + (!!this.var_74.finalLevel ? this.var_74.level : this.var_74.level - 1));
         this.var_49.localization.registerParameter("achievements.details.level","limit","" + this.var_74.levelCount);
         this.var_49.refreshReward(!this.var_74.finalLevel,this.var_481,this.var_74.levelRewardPointType,this.var_74.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_481,this.var_74);
         this.var_695.refresh(this.var_74.currentPoints,this.var_74.scoreLimit,this.var_74.type * 10000 + this.var_74.level);
         this.var_695.visible = !this.var_74.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this._window.y = const_1618;
         this.var_480 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_1064 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_854 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         ...
         this.var_1314 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_695 = new ProgressBar(this.var_49,this.var_481,const_1611,"achievements.details.progress",true,const_1615);
         this.var_857 = new ProgressBar(this.var_49,this.var_1314,const_1612,"achievements.categories.totalprogress",true,const_1619);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_480.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_702);
         var _loc5_:* = _loc4_ < const_1614;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1617) * (param1 % const_702);
            _loc3_.y = (_loc3_.height + const_1613) * Math.floor(param1 / const_702) + const_1616;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_854.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_1105);
         var _loc5_:* = _loc4_ < const_1608;
         if(_loc3_ == null)
         {
            if(param2 == null && !_loc5_)
            {
            ...
            _loc3_.x = _loc3_.width * (param1 % const_1105);
            _loc3_.y = _loc3_.height * _loc4_ + const_1610;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_480.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_480.getChildAt(_loc2_));
      ...
      private function onSelectAchievement(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.refresh();
         this.var_49.send(new EventLogMessageComposer("Achievements","" + this.var_74.type,"Achievement selected"));
      }
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc7_:int = const_1106 - _loc5_.height + this.getPositionFix(param2.type);
         var _loc8_:Point = new Point((_loc3_.width - _loc5_.width) / 2,!!_loc6_ ? Number(const_1609) : Number(_loc7_));
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_2024);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1106 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1315.identity();
         this.var_1315.scale(2,2);
         this.var_1315.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1315);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_2024);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_74 = this.var_1602;
         this.var_118.update(this.var_1602);
         this.var_1602 = null;
         this.refresh();
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_695.updateView();
         }
         if(this.var_857 != null)
         {
            this.var_857.updateView();
         }
         if(this.var_855 != null)
         {
            this.var_855.update(param1);
         }
      }
      ...
      {
         return !!this.var_696[param1] ? int(this.var_696[param1]) : 0;
      }

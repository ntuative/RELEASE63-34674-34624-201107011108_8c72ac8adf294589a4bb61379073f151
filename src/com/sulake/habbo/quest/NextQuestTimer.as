package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_1013:int = 1000;
      
      private static const const_697:String = "next_quest";
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_49.questController.onQuest(this.var_144);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_49.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_561 ? "expanded" : "contracted"));
      ...
      private function refreshVisibility() : void
      {
         ...
         this._window.findChildByName("more_info_txt").visible = this.var_561 && this.var_49.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_561 && this.var_49.currentlyInRoom;
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_49.questController.questDetails.showDetails(this.var_144);
         }
      }

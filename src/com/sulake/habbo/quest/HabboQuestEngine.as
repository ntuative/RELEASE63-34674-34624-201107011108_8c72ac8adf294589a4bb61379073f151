package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1445:int = 15;
      ...
      private var var_1172:QuestController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1172 = new QuestController(this);
         ...
         registerUpdateReceiver(this,const_1448);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_399.events.removeEventListener(BadgeImageReadyEvent.const_210,this.var_953.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_399.events.addEventListener(BadgeImageReadyEvent.const_210,this.var_953.onBadgeImageReady);
      }
      ...
      {
         return this.var_1172.questTracker.isVisible();
      }

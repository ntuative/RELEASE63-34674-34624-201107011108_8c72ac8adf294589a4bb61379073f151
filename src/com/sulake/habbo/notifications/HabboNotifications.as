package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1585:String = "pixelbalance";
      
      private static const const_1586:String = "badges";
      
      private static const const_1584:String = "selectbadge";
      
      private static const const_1587:String = "inventory";
      
      private static const const_1588:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1589:String = "friendlist";
      
      private static const const_1583:String = "pet_inventory";
      
      private static const const_1590:String = "go_to_room";
      ...
      private var var_1979:IHabboToolbar;
      ...
      private var var_838:ParkBusDialogManager;
      
      private var var_2706:Boolean;
      
      private var var_1041:ClubGiftNotification;
      
      private var var_1043:ClubEndingNotification;
      
      private var var_1042:ClubPromoNotification;
      
      private var var_3084:Dictionary;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1834 = false;
         this.var_3084 = new Dictionary();
         var _loc4_:IAsset = this._assetLibrary.getAssetByName("habbo_notifications_config_xml");
         var _loc5_:XmlAsset = XmlAsset(_loc4_);
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1044);
         }
         var _loc6_:Map = this.var_1044["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1044["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      {
         this.var_1979 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_564 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1979,this.var_1044["styles"],this.var_1044["view"]);
         ...
         registerUpdateReceiver(this.var_564,1);
         registerUpdateReceiver(this,2);
         this.var_399.events.addEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_399.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1319,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1319,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1728,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_779,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_399.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_64)
               {
                  _loc7_ = this.var_399.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_399.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1790,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1981,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1042 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1043 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_564.isSpaceAvailable() && this.var_1295.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_564.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1586:
               if(this.var_12 != null)
               {
                  this.var_12.method_1(InventoryCategory.const_214);
               }
               break;
            case const_1584:
               break;
            ...
            case const_1583:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.method_1(InventoryCategory.const_136);
               }
               break;
            case const_1588:
               break;
      ...
      {
         if(param1 != null && this.var_564 != null)
         {
            this.var_564.replaceIcon(param1);
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_838 == null)
         {
            this.var_838 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_838 != null)
         {
            this.var_838.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1210,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1210,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_951.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2706)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_779,null);
            this.var_2706 = true;
      ...
      {
         if(param2.type == WindowEvent.const_156 || param2.type == WindowEvent.const_670)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1041 && this.var_1041.visible)
         {
            return;
         }
         this.var_1041 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1979);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_779,_loc6_);
      }
   }
}

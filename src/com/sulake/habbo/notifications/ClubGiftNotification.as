package com.sulake.habbo.notifications
{
   ...
   public class ClubGiftNotification
   {
      ...
      private static const const_697:String = "club_gift_notification";
      
      private static const const_1427:uint = 16777215;
      
      private static const const_1425:uint = 12247545;
      ...
      public function ClubGiftNotification(param1:int, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboCatalog, param5:IHabboToolbar)
      {
         ...
         this._toolbar.extensionView.attachExtension(const_697,this._window);
         this.var_1726 = this._window.findChildByName("cancel_link") as ITextWindow;
      ...
      public function dispose() : void
      {
         if(this._toolbar)
         {
            this._toolbar.extensionView.detachExtension(const_697);
         }
         if(this._window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "open_catalog_button":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1729,true);
               }
               this.dispose();
               break;
      ...
      {
         this.var_1726.textColor = const_1425;
      }
      
      private function onMouseOut(param1:WindowMouseEvent) : void
      {
         this.var_1726.textColor = const_1427;
      }

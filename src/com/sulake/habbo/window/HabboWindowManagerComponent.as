package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1719:uint = 1;
      ...
      private var var_1680:IEventDispatcher;
      
      private var var_1394:Boolean = false;
      
      private var var_2182:ProfilerOutput;
      
      private var var_1678:ProfilerAgentTask;
      
      private var var_1679:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_235 = new Array(const_487);
         ...
         {
            this.var_235[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_702 = this.var_235[const_1719];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2182)
            {
               this.var_2182 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2182.profiler = _loc3_;
            this.var_1678 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1678);
            this.var_1679 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1679);
            this.var_1394 = true;
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_235)
            {
               ...
               {
                  IDisposable(this.var_235.pop()).dispose();
               }
            }
            this.var_235 = null;
            if(this.var_309)
      ...
      {
         return this.var_702.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_702.getWindowParser().windowToXMLString(param1);
      }
      ...
      {
         return this.var_235[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_235[param2].getDesktopWindow();
      ...
      {
         return this.var_235[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_235[param1].getDesktopWindow().getChildAt(this.var_702.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_235[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            this.var_1680.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_487 - 1;
            while(_loc2_ >= 0)
            {
               this.var_235[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1394)
         ...
         this.var_1680.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_487)
         {
            this.var_235[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1394)
         {
         ...
         this.var_1680.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1943,new Date().getTime().toString());
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1983,param2.name + ": " + param2.toString());
            }
         }
      }

package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1774:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1774 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_1001 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_277 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_1774.prepare(this.var_1001);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1361,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1367,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_983,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_796,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_983,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_796,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1462 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1462.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1776 == -1 ? 0 : int(this.var_16.height - this.var_1776);
         var _loc4_:int = this.var_1773 == -1 ? 0 : int(this.var_16.width - this.var_1773);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_277.y = Util.getLowestPoint(this.var_16.content);
         this.var_277.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1298,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_983,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1361,false);
         ...
         this.var_1776 = this.var_16.height;
         this.var_1773 = this.var_16.width;

package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_198:String = "face";
      ...
      private var var_607:IAvatarRenderManager;
      
      private var var_918:ISessionDataManager;
      
      private var var_3005:FriendListLookAndFeel;
      
      private var var_478:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_2193:OpenedToWebPopup;
      ...
      private var var_2192:AvatarSearchResults;
      ...
      {
         this.var_3005 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_2192 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_740.stop();
            this.var_740.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_740 = null;
         }
         ...
         if(this.var_607)
         {
            this.var_607.release(new IIDAvatarRenderManager());
            this.var_607 = null;
         }
         if(this.var_1028)
         {
         ...
         if(this.var_918)
         {
            this.var_918.release(new IIDSessionDataManager());
            this.var_918 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(this.var_2193 == null)
         {
            this.var_2193 = new OpenedToWebPopup(this);
         }
         this.var_2193.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_414);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_607.createAvatarImage(param1,AvatarScaleType.const_115,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_136.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_136.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_607 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_1028 = param2 as IHabboNotifications;
      ...
      {
         this.var_918 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1251,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_424,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_118.addFriend(new Friend(_loc4_));
         }
         this.var_478 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_740)
         {
            this.var_740 = new Timer(120000);
            this.var_740.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_740.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_424);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_478.findTab(FriendListTab.const_90).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_478.findTab(FriendListTab.const_90);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_2192.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_478.findTab(FriendListTab.const_90);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_478.findTab(FriendListTab.const_90);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_918 || !this.var_123)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_918.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_43))
         {
            _loc2_ = this.var_123.vipLimit;
         }
         else if(this.var_918.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_35))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_198) as IBitmapWrapperWindow;

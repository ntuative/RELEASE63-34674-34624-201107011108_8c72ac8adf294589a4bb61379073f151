package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_2104:String = "no_reqs_info";
      ...
      {
         this.var_2190 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2191 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2191.procedure = this.onDismissAllButtonClick;
         this.var_2190.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1257)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_415 && _loc2_.state != FriendRequest.const_452)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2190,_loc1_);
         this.setEnabled(this.var_2191,_loc1_);
      }

package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      {
         if(this.var_27 != null && this.var_27.furniModel != null && this.var_259 != null)
         {
            this.var_27.furniModel.removeLockFrom(this.var_259.id);
            this.var_259 = null;
         }
      }
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = this.var_259 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,this.var_259.ref));
         this.releaseItem();
      }
      ...
      public function getItemStats() : void
      {
         ...
         var _loc2_:int = this.var_259 is FloorItem ? 1 : 2;
         this.var_2282 = _loc2_;
         this.var_2286 = this.var_259.type;
         _loc1_.send(new GetMarketplaceItemStatsComposer(_loc2_,this.var_259.type));
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         {
            case 1:
               this._view.method_16(this.var_259);
               break;
            case 2:
            ...
            case 3:
               ...
               break;
            case 4:
               this._view.showBuyTokens(this.var_2074,this.var_2073);
         }
      }
      ...
      {
         if(param1 != this.var_2282 || param2 != this.var_2286)
         {
            return;
         }
         if(!this._view)
         ...
         this._view.updateAveragePrice(param3,this.var_2288);
      }

package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_144);
         _loc2_.refreshViews();
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_12.toggleInventorySubPage(InventorySubCategory.const_335);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_431);
      ...
      {
         var _loc2_:* = null;
         if(this.var_12.isInventoryCategoryInit(InventoryCategory.const_431))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_12.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_427));
         ...
         this.var_12.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1330));

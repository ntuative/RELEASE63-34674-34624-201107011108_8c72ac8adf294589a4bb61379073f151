package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_3039:BitmapData;
      
      private var var_1450:Boolean;
      
      private const const_2068:Number = 1;
      
      private const const_2069:Number = 0.2;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2333 = this._window.findChildByName("outline");
         this._roomEngine = param5;
         this.var_3039 = param6;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2246 == FurniModelCategory.const_37)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1514));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2245);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_2069;
               _loc1_.blend = this.const_2069;
            }
            else
            {
               this._window.blend = this.const_2068;
               _loc1_.blend = this.const_2068;
            }
         }
         this.var_1517.color = !!this.var_1450 ? uint(const_1444) : uint(const_1443);
         this.var_2333.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2244 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3039;
               _loc5_.visible = true;
            }
            else
            {

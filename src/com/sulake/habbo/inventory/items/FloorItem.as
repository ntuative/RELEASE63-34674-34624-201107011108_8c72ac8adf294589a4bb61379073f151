package com.sulake.habbo.inventory.items
{
   public class FloorItem implements IItem
   {
      ...
      protected var var_2536:Boolean;
      
      protected var var_3041:int;
      
      protected var var_2695:int;
      
      protected var var_2691:int;
      
      protected var var_2689:int;
      
      protected var var_1811:String;
      ...
      public function FloorItem(param1:int, param2:int, param3:int, param4:int, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:String, param10:Number, param11:int, param12:int, param13:int, param14:int, param15:String, param16:int)
      {
         ...
         this.var_3040 = param7;
         this.var_2536 = param8;
         this.var_2245 = param9;
         this.var_1514 = param10;
         this.var_3041 = param11;
         this.var_2695 = param12;
         this.var_2691 = param13;
         this.var_2689 = param14;
         this.var_1811 = param15;
         this.var_1853 = param16;
      }

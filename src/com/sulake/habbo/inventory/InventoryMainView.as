package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_466:int = 3;
      ...
      private const const_2070:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_27.inventoryViewOpened(this.var_846);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_400 != null && this.var_400 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_400 || !this.var_27.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_846);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_400);
         }
         ...
         _loc2_.container.removeChild(this.var_2006);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_400 == InventoryCategory.const_136)
            {
               this.toggleCategoryView(InventoryCategory.const_136);
            }
            else if(this.var_400 == InventoryCategory.const_78)
            {
               this.toggleCategoryView(InventoryCategory.const_78);
            }
            else if(this.var_27 != null)
            {
               this.var_27.method_1(InventoryCategory.const_78);
            }
         }
      }
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_2007)
         {
            this.var_2007 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_27.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_2007,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_466;
            _loc3_.y = const_466;
         }
         return _loc3_;
      }

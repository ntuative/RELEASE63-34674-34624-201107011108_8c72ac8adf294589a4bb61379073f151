package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_46:
               this.var_1562.setSelectedGridItem(this);
               this.var_1563 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1563 = false;
                  this.var_1562.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1517.color = !!this.var_1513 ? uint(const_1444) : uint(const_1443);
         this.var_2333.visible = param1;
      }

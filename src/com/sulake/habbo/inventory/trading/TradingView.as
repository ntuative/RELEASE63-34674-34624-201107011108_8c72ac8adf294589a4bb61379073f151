package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1153:uint = 4284532064;
      
      private static const const_1154:uint = 2577770;
      
      public static const const_1404:int = 0;
      
      public static const const_1281:int = 1;
      
      public static const const_1355:int = 2;
      ...
      private var var_743:ItemPopupCtrl;
      ...
      private var var_1131:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_743 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_2198 = this.createMinimizedWindow();
         }
         if(!this.var_1154)
         {
            return this.var_81;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_81)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1153) : uint(const_1154);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1153) : uint(const_1154);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1131)
         {
            this.var_1131.isSelected = false;
            this.var_1131 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_1841)
            {
            ...
            this.var_743.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_533);
            this.var_743.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_743.hideDelayed();
         }
      }
         ...
         if(this.var_208.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_743.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_533);
               }
            }
            else
            {

package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1051:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_689 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_689.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1051 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1051.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_689.scrollV;
         this.var_689.removeGridItems();
         this.var_1051.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_583);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_689.addGridItem(_loc3_.window);
         ...
         while(_loc4_ < _loc5_.length)
         {
            ...
            this.var_1051.addGridItem(_loc3_.window);
      ...
      {
         var _loc2_:int = this.var_689.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1051.getGridItemIndex(param1.window);

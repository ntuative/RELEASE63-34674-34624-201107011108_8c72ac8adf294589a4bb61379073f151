package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_399 = param5;
         this.var_399.events.addEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_399.events.removeEventListener(BadgeImageReadyEvent.const_210,this.onBadgeImageReady);
            this.var_399 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1321.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_701.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_399.getBadgeImage(param1);
            if(_loc10_)
            {
               this.var_261.unshift(_loc11_);
            }
            else
            {
               this.var_261.push(_loc11_);
            }
            if(param2)
            {
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         while(_loc2_ < this.var_261.length)
         {
            _loc3_ = this.var_261[_loc2_] as Badge;
            if(_loc3_ != null)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_583);
      ...
      {
         return this.getItemInIndex(param1,const_583);
      }
      ...
      {
         if(param1 == InventoryCategory.const_214 && this.var_27.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_701.indexOf(_loc2_) == -1)
            {
               this.var_701.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_701 && this.var_701.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1330));
            this.var_701 = [];
            for each(_loc2_ in this.var_261)
            {

package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_62.getValue(InventorySubCategory.const_335));
      }
      ...
      public function get effectsModel() : EffectsModel
      {
         ...
         return EffectsModel(this.var_62.getValue(InventoryCategory.const_144));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_62.getValue(InventoryCategory.const_214));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_62.getValue(InventorySubCategory.const_1188));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_62.getValue(InventoryCategory.const_136));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_62.getValue(InventoryCategory.const_431) as MarketplaceModel;
      }
      ...
      {
         this.var_399 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_399 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_62.add(InventoryCategory.const_431,_loc1_);
         ...
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_399);
         this.var_62.add(InventoryCategory.const_214,_loc3_);
         ...
         this.var_62.add(InventoryCategory.const_144,_loc4_);
         ...
         this.var_62.add(InventorySubCategory.const_335,_loc5_);
         ...
         this.var_62.add(InventorySubCategory.const_1188,_loc6_);
         ...
         this.var_62.add(InventoryCategory.const_136,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = this.var_977.indexOf(param1);
            if(_loc3_ >= 0)
            {
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2348);
         }
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2459)
         {
            this.var_2459 = _loc1_;

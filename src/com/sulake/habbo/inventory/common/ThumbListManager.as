package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_105 = this.var_643.height;
         this.var_1199 = param5;
         this.var_971 = param6;
         this.var_247 = Math.floor(this.var_1199 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1199,this.var_971);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         this.var_644 = this.resolveRowCountFromList();
         if(this.var_644 == 0)
         {
            this.var_28 = new BitmapData(this.var_1199,this.var_971);
            return;
         }
         this.var_28 = new BitmapData(Math.max(this.var_247 * this._thumbWidth,this.var_1199),Math.max(this.var_644 * this.var_105,this.var_971),true,16777215);
         this.var_28.fillRect(this.var_28.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = this.getList();
         var _loc3_:int = 0;
         while(_loc3_ < this.var_644)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_247 && this.var_28.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,0,this._thumbWidth * (this.var_247 - 1),this.var_105);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(this._thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(this._thumbWidth * (this.var_247 - 1),0,this._thumbWidth,this.var_28.height);
         _loc2_.copyPixels(this.var_28,_loc4_,new Point(0,this.var_105),null,null,true);
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_247 - 1),this.var_28.height - this.var_105);
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_28.height < this.var_971)
         {
            _loc12_ = new BitmapData(this.var_28.width,this.var_971);

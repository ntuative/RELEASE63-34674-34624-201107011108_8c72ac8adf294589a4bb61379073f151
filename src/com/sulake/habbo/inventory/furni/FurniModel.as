package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private var var_1503:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_448 = [];
         this.var_447 = [];
         this.var_654 = new Timer(const_1506,1);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_143,this.onObjectPlaced);
               }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_37)
            {
               ...
               {
                  this.var_1503 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1503;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_791 == null)
         {
            this.var_791 = this._windowManager.buildFromXML(this.var_2528) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_791.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_791.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_78 && this.var_27.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_263:
                  this.var_27.method_1(InventoryCategory.const_136);
            }
         }
      }
      ...
      {
         this.var_27.checkCategoryInitilization(InventoryCategory.const_431);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_655.add(const_37,new Array());
         this.var_655.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_263)
            {
      ...
      {
         return getTimer() < this.var_2526 + const_1507;
      }
      ...
      {
         return this.var_27.getSubCategoryViewId() == InventorySubCategory.const_335;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_381 || _loc3_.category == FurniCategory.const_358 || _loc3_.category == FurniCategory.const_323)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               ...
               if(_loc4_.category == FurniCategory.const_814)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            case UnseenItemCategoryEnum.const_427:
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         switch(param1)
         {
            ...
            case const_37:
               ...
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_427));
                  this.var_448 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
         }

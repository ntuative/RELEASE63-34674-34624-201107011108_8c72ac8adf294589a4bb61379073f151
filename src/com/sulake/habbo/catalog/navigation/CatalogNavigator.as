package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_3117:String = "magic.credits";
      
      private var var_3086:String = "magic.pixels";
      
      private var var_3085:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_3086);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_3085,true);
      }

package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1682:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1655:XML;
      
      private static var var_1654:XML;
       
      
      private var var_2133:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3093:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1655 == null)
         {
            ...
            var_1655 = _loc4_.content as XML;
         }
         if(var_1654 == null)
         {
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_2133 == 4294967295)
            {
               this.var_2133 = _loc1_.color;
            }
            _loc1_.color = const_1682;
         }
      }
      ...
      {
         this.var_67 = navigator.catalog.windowManager.buildFromXML(var_1654) as IItemListWindow;
         if(this.var_67 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1655) as IWindowContainer;
         }
         else
         {
      ...
      private function retrieveIconImage(param1:String) : void
      {
         ...
         _loc5_.addEventListener(AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE,this.method_14);
      }
      
      private function method_14(param1:AssetLoaderEvent) : void
      {
         var _loc3_:* = null;

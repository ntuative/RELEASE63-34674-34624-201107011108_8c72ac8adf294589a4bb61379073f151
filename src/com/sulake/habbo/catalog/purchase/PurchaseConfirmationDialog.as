package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2377:int = 10;
      ...
      private const const_2063:uint = 4.294967295E9;
      
      private const const_1471:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1340 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            _loc7_.addEventListener(WindowEvent.const_348,this.onMessageInputFocus);
         }
         this.var_2095 = true;
         this.var_2097 = true;
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               _loc12_.addEventListener(WindowEvent.const_368,this.onFreeWrappingSelected);
            ...
            this.var_2096 = _loc1_.stuffTypes;
            this.var_873 = _loc1_.boxTypes;
            this.var_874 = _loc1_.ribbonTypes;
            this.var_1341 = this.var_2096[0];
            this.var_412 = this.var_873[0];
            this.var_413 = this.var_874[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_413 > this.var_874.length - 1)
         {
            this.var_413 = 0;
         }
         if(this.var_412 < 0)
         {
            this.var_412 = this.var_873.length - 1;
         }
         if(this.var_412 > this.var_873.length - 1)
         {
            this.var_412 = 0;
         }
         var _loc1_:int = this.var_873[this.var_412] * 1000 + this.var_874[this.var_413];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1341,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1634 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_2096)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1341);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_873[this.var_412]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_874[this.var_413]);
         this._catalog.purchaseProductAsGift(this.var_1633,this.var_1340,this.var_1635,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1633,this.var_1340,this.var_1635);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         for each(_loc5_ in this.var_245)
         {
            ...
            if(_loc4_.length >= this.const_2377)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2884 = _loc2_.text;
      }
      ...
      {
         if(this.var_305 == null || !this.var_305.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_305.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_305 == null)
         {
            this.var_305 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_875 == null)
         {
            this.var_875 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_305 == null || this.var_875 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_305.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_875.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_305.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1471;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2064) : uint(this.const_2063);
      }
      ...
      {
         this.var_1341 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1341;
               }
            }
            _loc4_++;
         }

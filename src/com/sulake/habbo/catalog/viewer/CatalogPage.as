package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_2043:String = "ctlg_";
       
      
      protected var var_2254:XML;
      ...
      {
         return this._localization.getLinks(this.var_1234);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1234);
      }
      ...
      {
         var _loc2_:String = const_2043 + param1;
         ...
         this.var_2254 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2254) as IWindowContainer;
         if(this._window == null)
         {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1951:
               if(this.var_1235 == null)
               {
                  ...
                  this.var_38.push(this.var_1235);
               }
               break;

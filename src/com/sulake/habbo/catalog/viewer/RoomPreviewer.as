package com.sulake.habbo.catalog.viewer
{
   ...
   public class RoomPreviewer
   {
      ...
      private static const const_1542:int = 64;
      
      private static const const_1541:int = 32;
      
      private static const const_1543:int = 2500;
      ...
      public function RoomPreviewer(param1:IRoomEngine)
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_192,this.onRoomObjectAdded);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_764,this.onRoomObjectAdded);
      ...
      public function dispose() : void
      {
         ...
         {
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_192,this.onRoomObjectAdded);
            this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_764,this.onRoomObjectAdded);
      ...
      public function reset() : void
      {
         ...
         this.var_336 = RoomObjectCategoryEnum.const_141;
      }
      ...
      public function addFurnitureIntoRoom(param1:int, param2:IVector3d) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_336 == RoomObjectCategoryEnum.const_27 && this.var_1260 == param1)
            {
               return const_66;
            }
            this.reset();
      ...
      public function addWallItemIntoRoom(param1:int, param2:IVector3d, param3:String) : int
      {
         if(this._roomEngine != null)
         {
            if(this.var_336 == RoomObjectCategoryEnum.const_26 && this.var_1260 == param1 && this.var_1533 == param3)
            {
               return const_66;
            }
            this.reset();
      ...
      private function checkAutomaticRoomObjectStateChange() : void
      {
         ...
         {
            _loc1_ = getTimer();
            if(_loc1_ > this.var_1261 + const_1543)
            {
               this.var_1261 = _loc1_;
               if(this._roomEngine != null)
               {
                  this._roomEngine.changeObjectState(const_53,const_54,const_66,this.var_336);
               }
      ...
      public function getRoomCanvas(param1:int, param2:int) : DisplayObject
      {
         ...
         if(this._roomEngine != null)
         {
            _loc3_ = this._roomEngine.createRoomCanvas(const_53,const_54,const_237,param1,param2,this.var_1263);
      ...
      private function updatePreviewObjectBoundingRectangle(param1:Point) : void
      {
         ...
         {
            _loc2_.offset(-(this.var_1259 >> 1),-(this.var_1014 >> 1));
            ...
            else
            {
               ...
               if(_loc3_.width - this.var_50.width > this.var_1259 - this.var_50.width >> 1 || _loc3_.height - this.var_50.height > this.var_1014 - this.var_50.height >> 1 || this.var_50.width < 1 || this.var_50.height < 1)
               {
                  this.var_50 = _loc3_;
               }
            }
      ...
      private function validatePreviewSize(param1:Point) : Point
      {
         ...
         if(this.var_50.width > this.var_1259 * (1 + const_472) || this.var_50.height > this.var_1014 * (1 + const_472))
         {
            if(_loc2_.isZoomedIn())
            {
               _loc2_.performZoomOut();
               this.var_1263 = const_1541;
               this.var_1929 = true;
               param1.x >>= 1;
               param1.y >>= 1;
               this.var_50.left >>= 2;
         ...
         else if(this.var_50.width << 1 < this.var_1259 * (1 + const_472) - 5 && this.var_50.height << 1 < this.var_1014 * (1 + const_472) - 5)
         {
            if(!_loc2_.isZoomedIn() && !this.var_1929)
            {
               _loc2_.performZoomIn();
               this.var_1263 = const_1542;
               param1.x <<= 1;
               param1.y <<= 1;
            }
         }
      ...
      private function getCanvasOffset(param1:Point) : Point
      {
         ...
         var _loc4_:* = this.var_1014 - this.var_50.height >> 1;
         if(_loc4_ > 10)
         {
      ...
      public function updatePreviewRoomView() : void
      {
         ...
         if(this._roomEngine != null)
         {
            _loc1_ = this._roomEngine.method_8(const_53,const_54,const_237);
            if(_loc1_ != null)
            {
      ...
      private function onRoomObjectAdded(param1:RoomEngineObjectEvent) : void
      {
         ...
         if(param1.roomId == const_53 && param1.roomCategory == const_54 && param1.objectId == const_66 && param1.category == this.var_336)
         {
            ...
            {
               _loc3_ = _loc2_.getModel().getNumber(RoomObjectVariableEnum.const_646);

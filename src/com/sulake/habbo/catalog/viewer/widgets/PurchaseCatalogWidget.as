package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PurchaseCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         events.removeEventListener(WidgetEvent.const_884,this.onSetParameter);
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            this.var_2596 = _loc1_.content as XML;
         }
         var _loc2_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetPixelsStub") as XmlAsset;
         if(_loc2_ != null)
         {
            this.var_2594 = _loc2_.content as XML;
         }
         var _loc3_:XmlAsset = page.viewer.catalog.assets.getAssetByName("purchaseWidgetCreditsPixelsStub") as XmlAsset;
         if(_loc3_ != null)
         {
            this.var_2595 = _loc3_.content as XML;
         }
         ...
         if(_loc5_ != null)
         {
            this.var_2593 = _loc5_.content as XML;
         }
         ...
         if(_loc7_ != null)
         {
            this.var_2597 = _loc7_.content as XML;
         }
         events.addEventListener(WidgetEvent.CWE_SELECT_PRODUCT,this.onSelectProduct);
         events.addEventListener(WidgetEvent.const_884,this.onSetParameter);
      ...
      private function attachStub(param1:String, param2:int) : void
      {
         ...
         else
         {
            switch(param2)
            {
               case HabboClubLevelEnum.const_35:
                  _loc3_ = page.viewer.catalog.windowManager.buildFromXML(this.var_2593) as IWindowContainer;
                  break;
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _window.removeChild(this.var_1010);
               this.var_1010.dispose();
            }
            this.var_1010 = _loc3_;
            _window.addChild(_loc3_);
            this.var_1010.x = 0;
            this.var_1010.y = 0;
         }
         this.var_1903 = _window.findChildByName("ctlg_price_credits") as ITextWindow;
         this.var_1902 = _window.findChildByName("ctlg_price_pixels") as ITextWindow;
         this.var_1905 = _window.findChildByName("ctlg_price_credits_pixels") as ITextWindow;
         this.var_3076 = _window.findChildByName("ctlg_special_txt") as ITextWindow;
         this.var_666 = window.findChildByName("ctlg_buy_button") as IButtonWindow;
         this.var_1901 = window.findChildByName("ctlg_buy_club_button") as IButtonWindow;
         if(this.var_666 != null)
         {
            if(this.var_1526 != null)
            {
               this.var_666.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1526);
            }
            else
            {
               this.var_666.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_1526);
         ...
         {
            this.var_1901.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onBuyClub);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_1903 != null)
         {
            ...
            this.var_1903.caption = "${catalog.purchase.price.credits}";
         }
         ...
         if(this.var_1902 != null)
         {
            ...
            this.var_1902.caption = _loc2_.getKey(_loc4_);
         }
      ...
      {
         this.var_1904 = param1.parameter;
      }
      ...
      private function onPurchase(param1:WindowMouseEvent) : void
      {
         ...
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_104,page.pageId,this.var_1904);
         }
      }
      ...
      private function initPurchase(param1:CatalogWidgetInitPurchaseEvent) : void
      {
         if(this.var_104 != null)
         {
            (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_104,page.pageId,this.var_1904,param1.enableBuyAsGift);
         }
      }

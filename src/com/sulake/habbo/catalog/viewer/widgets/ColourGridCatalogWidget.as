package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         if(!this.var_379.disposed)
         {
            this.var_379.destroyGridItems();
      ...
      override public function init() : Boolean
      {
         ...
         this.var_379 = _window.findChildByName("colourGrid") as IItemGridWindow;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.select(this.var_379.getGridItemAt(param1.index) as IWindowContainer);
      }
      ...
      private function onAvailableMultiColours(param1:CatalogWidgetMultiColoursEvent) : void
      {
         ...
         for each(_loc2_ in param1.colours)
         {
            this.var_974.push(_loc2_.slice());
         }
         _loc3_ = page.viewer.catalog.assets.getAssetByName(param1.backgroundAssetName) as BitmapDataAsset;
         this.var_645 = _loc3_.content as BitmapData;
         _loc4_ = page.viewer.catalog.assets.getAssetByName(param1.colourAssetName) as BitmapDataAsset;
         ...
         this.var_947 = _loc5_.content as BitmapData;
         this.populateColourGrid();
         this.select(this.var_379.getGridItemAt(0) as IWindowContainer);
      }
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc12_:int = 0;
         var _loc13_:int = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_974.length,this.var_379.numGridItems]);
         this.var_379.destroyGridItems();
         this.var_237 = null;
         for each(_loc1_ in this.var_974)
         {
            if(_loc1_.length > 0)
            {
               ...
               _loc2_.width = this.var_645.width;
               _loc2_.height = this.var_645.height;
               this.var_379.addGridItem(_loc2_);
               _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
               if(_loc3_ != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_645.width,this.var_645.height,true,0);
                  _loc3_.bitmap.copyPixels(this.var_645,this.var_645.rect,new Point(0,0));
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_379.getGridItemIndex(param1.target as IWindow);

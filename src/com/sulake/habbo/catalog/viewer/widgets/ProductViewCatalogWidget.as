package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_601:IDisplayObjectWrapper;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_209.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_209 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1135 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1403 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_101 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_209 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_209 != null)
         {
            this.var_209.visible = false;
            this.var_601 = this.var_209.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_601 != null && _loc3_ != null)
            {
               this.var_209.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_601.width,this.var_601.height);
               if(_loc4_ != null)
               {
                  this.var_601.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_2201 = new Point(this.var_101.x,this.var_101.y);
         this.var_600 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1692 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1135.text = _loc4_;
         this.var_1403.text = _loc5_;
         this.var_1135.height = this.var_1135.textHeight + 5;
         this.var_1403.y = this.var_1135.y + this.var_1135.height;
         this.var_1403.height = Math.max(130,this.var_1403.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_636:
                  ...
                  if(this.var_600 != null)
                  {
                     this.var_600.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_600,this.var_1692,this.var_1797);
               ...
               case Offer.const_433:
                  ...
                  if(this.var_209 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_79 || _loc9_.productType == ProductTypeEnum.const_64 || _loc9_.productType == ProductTypeEnum.const_181)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_79:
                        if(_loc8_ != null && this.var_601 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_338,AvatarAction.const_622);
                                 _loc18_.appendAction(AvatarAction.const_376,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_3030)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_3030 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_101 != null && true)
         {
            ...
            this.var_101.x = this.var_2201.x;
            this.var_101.y = this.var_2201.y;
            if(param3 != null)
            {

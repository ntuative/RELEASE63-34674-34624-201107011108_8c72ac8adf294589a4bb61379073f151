package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid, IDragAndDropDoneReceiver
   {
      ...
      {
         var _loc2_:Offer = this.var_211[this.var_519][this.var_650];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_519 = var_504.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_519];
         var _loc3_:Array = this.var_211[this.var_519] as Array;
      ...
      {
         var _loc2_:Array = this.var_211[this.var_519] as Array;
      ...
      private function updateGridWithSelectedColour() : void
      {
         ...
         var _loc1_:Array = this.var_211[this.var_519] as Array;
         ...
         for each(_loc1_ in page.offers)
         {
            if(_loc1_.pricingModel == Offer.const_421 || _loc1_.pricingModel == Offer.const_433)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_64 || _loc3_.productType == ProductTypeEnum.const_79)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        (this.var_211[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }

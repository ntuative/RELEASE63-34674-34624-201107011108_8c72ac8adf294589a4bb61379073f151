package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IPetDataListener, IPetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.var_2316 = _loc3_.localizationId;
         this.var_368 = [];
         if(page && false && page.viewer.catalog)
         {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         this.var_520 = param1.index;
         if(this.var_520 < 0 || this.var_520 > this.var_368.length)
         {
            this.var_520 = 0;
         }
         this.updateImage();
      ...
      private function updateImage() : void
      {
         ...
         if(this.var_520 >= 0 && this.var_520 < this.var_368.length)
         {
            _loc7_ = this.var_368[this.var_520] as IPetColor;
            if(_loc7_ != null)
            {
         ...
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImage(this.var_591,_loc3_,_loc2_,AvatarScaleType.const_61,this);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_338,AvatarAction.const_773);
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(this.var_520 >= this.var_368.length)
         {
            return "";
         }
         var petColor:IPetColor = this.var_368[this.var_520] as IPetColor;

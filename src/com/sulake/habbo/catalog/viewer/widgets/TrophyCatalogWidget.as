package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1518:int = 16763904;
      
      private static const const_1520:int = 13421772;
      
      private static const const_1519:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_285.getWithIndex(this.var_327);
         if(_loc4_ != null)
         {
      ...
      private function onWidgetsInitialized(param1:CatalogWidgetsInitializedEvent) : void
      {
         ...
         _loc2_.push(const_1518);
         _loc2_.push(const_1520);
         _loc2_.push(const_1519);
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_285.getWithIndex(this.var_327);
         if(_loc2_ != null)
         {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_327;
         if(this.var_327 >= this.var_285.length)
         {
            this.var_327 = 0;
         }
         var _loc2_:Map = this.var_285.getWithIndex(this.var_327);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_327 < 0)
         {
            this.var_327 = this.var_285.length - 1;
         }
         var _loc2_:Map = this.var_285.getWithIndex(this.var_327);
         if(_loc2_ != null)
         {

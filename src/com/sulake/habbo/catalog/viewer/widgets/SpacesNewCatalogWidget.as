package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_478:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer, param2:ISessionDataManager)
      {
         ...
         super(param1,param2);
         this.var_478 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_478)
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_478.numSelectables)
            {
               _loc4_ = this.var_478.getSelectableAt(_loc3_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_519]);
      ...
      {
         var _loc2_:int = this.var_650[this.var_519];
         var _loc3_:Offer = this.var_211[this.var_519][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_211[this.var_519][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_650[this.var_519] = (this.var_211[this.var_519] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      ...
      private function updateRoomPreview() : void
      {
         ...
         var _loc4_:Offer = this.var_211[0][_loc1_];
         var _loc5_:Offer = this.var_211[1][_loc2_];
         var _loc6_:Offer = this.var_211[2][_loc3_];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_421 || _loc1_.pricingModel == Offer.const_433))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_64 || _loc2_.productType == ProductTypeEnum.const_79))
            {
               continue;
            }
            ...
            while(this.var_211.length < this._groupNames.length)
            {
               this.var_211.push(new Array());
            }
            switch(_loc4_)
            {
               case "floor":
                  (this.var_211[_loc5_] as Array).push(_loc1_);
                  break;
               case "wallpaper":
                  (this.var_211[_loc5_] as Array).push(_loc1_);
                  break;
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_478.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_211[this.var_519],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_650[this.var_519];

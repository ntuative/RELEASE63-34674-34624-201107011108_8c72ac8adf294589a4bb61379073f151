package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1522:String = "your_price_icon";
      
      private static const const_1523:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1525:String = "image/png";
      
      private static const const_1524:int = 2000;
      
      private static const const_1521:int = 75;
      ...
      private var var_660:Vector.<BitmapData>;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_27 = param1;
         this.var_104 = param2;
         this.var_660 = new Vector.<BitmapData>(const_388);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_660)
         {
            ...
            {
               this.var_660[_loc1_].dispose();
               this.var_660[_loc1_] = null;
               _loc1_++;
            }
            this.var_660 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_661 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_659 || !this.var_661)
         {
            return;
         }
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1523,const_1525,this.onTeaserLoaded);
         ...
         this.var_387 = this._view.findChildByName(const_1522) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_388)
         {
            ...
            this.var_660[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_661)
         {
            this.var_661.textColor = const_2044;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_661)
         {
            this.var_661.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_804 = new Timer(const_1524);
         this.var_804.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_804.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_662 < const_388)
         {
            ...
            this.var_387.bitmap.copyPixels(this.var_660[this.var_662],this.var_660[this.var_662].rect,new Point(0,0));
         }
         else
         {
      ...
      {
         this.var_454 = new Timer(const_1521,const_388 - 1);

package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_673 != const_1089;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1948 != RecyclerStatusMessageEvent.const_1377;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_673 == const_474;
      }
      ...
      {
         this.var_673 = const_1090;
         this.var_134 = new Array(const_228);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1948)
         {
            case RecyclerStatusMessageEvent.const_1834:
               this.var_673 = const_474;
            ...
            case RecyclerStatusMessageEvent.const_1377:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1812:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1363:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1758:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_134.length < const_228)
         {
            return false;
         }
         var _loc1_:int = 0;

package com.sulake.habbo.toolbar.extensions.purse
{
   ...
   public class CurrencyIndicatorBase implements ICurrencyIndicator
   {
      ...
      protected function createWindow(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            ...
            if(this._view)
            {
               ...
               {
                  this.var_670 = _loc4_[0] as IBitmapWrapperWindow;
      ...
      protected function animateIcon(param1:int) : void
      {
         ...
         if(this.var_670 && this.var_288.length > 0)
         {
            if(this.var_1930 == ANIM_DIRECTION_FORWARD)
            {
               this.var_287 = 0;
            }
            else
            ...
            this.var_671 = new Timer(this.var_2636,this.var_288.length);
      ...
      protected function setText(param1:String) : void
      {
         if(this._view)
         {
            this._view.findChildByName(this.var_1931).caption = param1;
            this._view.findChildByName(this.var_1932).caption = param1;
         }
      }
      ...
      protected function setTextUnderline(param1:Boolean) : void
      {
         ...
         if(this._view)
         {
            _loc2_ = this._view.findChildByName(this.var_1931) as ITextWindow;
            _loc3_ = this._view.findChildByName(this.var_1932) as ITextWindow;
      ...
      private function setIconBitmap(param1:BitmapData) : void
      {
         if(this.var_670)
         {
            this.var_670.bitmap = param1.clone();
            this.var_670.width = param1.width;
            this.var_670.height = param1.height;
            this.var_670.invalidate();
         }
      }
      
      private function onContainerMouseOver(param1:WindowMouseEvent) : void
      {
         this._view.color = this.var_2633;
      }
      
      private function onContainerMouseOut(param1:WindowMouseEvent) : void
      {
         this._view.color = this.var_2634;
      }
   }
}

package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1471:uint = 12247545;
      
      private static const const_1470:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_397 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_67.removeListItem(this.var_397);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_397,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_322)
         {
            this.var_322 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_322.x = _loc1_.x + this._window.width - this.var_322.width;
            this.var_322.y = _loc1_.y + this._window.height - this.var_322.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1470);
               break;

package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1472:String = "purse";
      
      private static const const_1473:String = "extra_tools";
      ...
      private var var_1196:PurseExtension;
      
      private var var_1471:ClubDiscountPromoExtension;
      ...
      {
         if(this.var_274 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","false") == "true")
         {
            ...
            if(this.var_639)
            {
               this.var_1196 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               ...
               {
                  this.var_1471 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_639.attachExtension(const_1472,this.var_1196.window,ExtensionFixedSlotsEnum.const_1965);
               this.var_639.attachExtension(const_1473,this.var_640.window,ExtensionFixedSlotsEnum.const_1831);
            }
         }
         if(this._view == null)
         {

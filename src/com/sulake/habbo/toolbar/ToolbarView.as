package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1457:uint = 7433577;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.addEventListener(WindowEvent.const_600,this.onParentResized);
         ...
         this.var_213.x = _loc13_.width - this.var_213.width - const_466;
         this.var_213.y = const_466;
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         if(!param1 && _loc2_ == this.var_1455)
         {
            return;
         }
         this.var_1455 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1458) : int(const_1460);
         var _loc4_:int = !!_loc2_ ? int(const_1455) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1454 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1456;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_213 != null && this.var_2347)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_758:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_864:
               _loc3_ = true;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_467 ? this.var_1454 : this.var_1456;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1455 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1455 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         if(this.var_1456)
         {
            this.var_1456.dispose();
         }
         this.var_1456 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1454)
         {
            this.var_1454.dispose();
         }
         this.var_1454 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_955.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_466;
            _loc2_.y = const_466;
            this.var_955.add(param1,_loc2_);
         }
         return _loc2_;
      }

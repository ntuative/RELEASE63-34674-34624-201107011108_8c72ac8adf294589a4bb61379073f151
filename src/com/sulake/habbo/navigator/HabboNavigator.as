package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_726:RoomInfoViewCtrl;
      
      private var var_1373:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_478:Tabs;
      ...
      private var var_2416:RoomThumbnailRenderer;
      
      private var var_1101:GuestRoomPasswordInput;
      
      private var var_339:GuestRoomDoorbell;
      
      private var var_1374:OfficialRoomEntryManager;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_726 = new RoomInfoViewCtrl(this);
         this.var_1373 = new RoomCreateViewCtrl(this);
         this.var_2416 = new RoomThumbnailRenderer(this);
         this.var_1101 = new GuestRoomPasswordInput(this);
         this.var_339 = new GuestRoomDoorbell(this);
         this.var_478 = new Tabs(this);
         this.var_1374 = new OfficialRoomEntryManager(this);
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_136.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_350.startSearch(Tabs.const_315,Tabs.const_601,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_350.startSearch(Tabs.const_280,Tabs.const_283);
         this.var_478.getTab(Tabs.const_280).tabPageDecorator.tabSelected();
      }

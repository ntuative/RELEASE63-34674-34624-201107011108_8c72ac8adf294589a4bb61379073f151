package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1361:TextFieldManager;
      ...
      private var var_1358:TextFieldManager;
      ...
      private var var_893:ICheckBoxWindow;
      
      private var var_2139:ITextWindow;
      
      private var var_1099:IDropMenuWindow;
      
      private var var_1100:IDropMenuWindow;
      
      private var var_2918:IWindowContainer;
      ...
      {
         this.var_420 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_420));
      ...
      {
         if(param1 != this.var_420 || this.var_1360 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1360 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1869)
         {
            this.var_892.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1858)
         {
            this.var_892.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1874)
         {
            this.var_1361.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1941)
         {
            this.setTagError(this.var_1046,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1047,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1780)
         {
            this.setTagError(this.var_1046,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_1047,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1972)
         {
            this.var_1101.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_892.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_368,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_615,this.onDoorModePasswordUnselect);
         ...
         this.var_892 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1361 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1046 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1047 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1101 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1358 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1357 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1364 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1363 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_893 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2139 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1099 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1100 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_2918 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1365 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1359 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2141 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1661 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_265 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1362 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1660 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1660.mouseThreshold = 0;
         this.var_1660.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1362.visible = false;
         if(!this.var_1659)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2141.visible = this.var_1659;
         this.populateForm();
         if(this.var_891)
         {
            ...
            this.var_1359.height = Util.getLowestPoint(this.var_1359) + 4;
         }
         else
         {
            this.var_1365.visible = true;
            this.var_1661.visible = true;
            this.var_2918.visible = this.var_1659;
            this.var_1365.height = Util.getLowestPoint(this.var_1365) + 4;
         }
         this.var_1660.text = !!this.var_891 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1365.name,this.var_1359.name,this.var_1661.name,this.var_2141.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_892.setText(_loc1_.name);
         this.var_1361.setText(_loc1_.description);
         this.var_1101.setText("");
         this.var_1358.setText("");
         ...
         this.setTag(this.var_1046,_loc1_.tags[0]);
         this.setTag(this.var_1047,_loc1_.tags[1]);
         if(this.var_1357)
         {
            if(_loc1_.allowPets)
            {
         ...
         {
            this.disableWindow(this.var_893);
            this.disableWindow(this.var_1099);
            this.disableWindow(this.var_1100);
            this.disableWindow(this.var_2139);
         }
         else
         {
            this.enableWindow(this.var_893);
            this.enableWindow(this.var_1099);
            this.enableWindow(this.var_1100);
            this.enableWindow(this.var_2139);
         }
         if(this.var_893)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_893.unselect();
            }
         }
         if(this.var_1099)
         {
            this.var_1099.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1100)
         {
            this.var_1100.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_892.getText();
         _loc2_.description = this.var_1361.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_630;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_126)
         {
            _loc8_ = this.var_1101.getText();
            _loc9_ = this.var_1358.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1101.clearErrors();
               this.var_1358.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1357.isSelected;
         _loc2_.allowFoodConsume = this.var_1364.isSelected;
         _loc2_.allowWalkThrough = this.var_1363.isSelected;
         _loc2_.hideWalls = this.var_893.isSelected;
         _loc2_.wallThickness = this.var_1099.selection - 2;
         _loc2_.floorThickness = this.var_1100.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1046,_loc2_.tags);
         this.addTag(this.var_1047,_loc2_.tags);
         this.clearErrors();
         this.var_1360 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_420);
         if(this.var_57 == null)
         {
            return;
         }
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_57.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.method_15,[this.var_420]);
         _loc2_.show();
      }
      
      private function method_15(param1:WindowMouseEvent, param2:int) : void
      {
         var _loc3_:* = null;
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_69,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_420));
      }

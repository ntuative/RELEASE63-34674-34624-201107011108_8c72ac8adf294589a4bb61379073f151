package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1387:TextFieldManager;
      
      private var var_45:Array;
      
      private var var_1386:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_736 = new Timer(100);
         this.var_736.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_736)
         {
            this.var_736.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_736.reset();
            this.var_736 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1386.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2177 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2177 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_67 = IItemListWindow(this.var_207.findChildByName("item_list"));
         ...
         this.var_1387 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_207.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1387.goBackToInitialState();
         this.var_1387.input.textBackgroundColor = 4294967295;
         this.var_1386 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_69,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1387.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1387.getText();
         var _loc3_:String = "model_" + this.var_1386.name;

package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_161 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_411);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_987);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_207,Tabs.const_411,"" + _loc3_);
         }
         if(this.var_161)
         {
            this._navigator.trackNavigationDataPoint(this.var_161.enumerateSelection()[this.var_161.selection],"category.view");
         }
      }

package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1866:IButtonWindow;
      
      private var var_1868:IButtonWindow;
      
      private var var_1867:IButtonWindow;
      
      private var var_2555:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1866 = IButtonWindow(this.find("bg_tab"));
         this.var_1868 = IButtonWindow(this.find("top_tab"));
         this.var_1867 = IButtonWindow(this.find("obj_tab"));
         this.var_2555 = IWindowContainer(this.find("tile_grid"));
         this.var_2554 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1866,this.onBgTabButton);
      ...
      {
         this.setEnabled(this.var_1866,this.var_78.mode != ThumbnailEditorModel.const_39);
         this.setEnabled(this.var_1868,this.var_78.mode != ThumbnailEditorModel.const_65);
         this.setEnabled(this.var_1867,this.var_78.mode != ThumbnailEditorModel.const_34);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2554;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2555;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_537)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(this._navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_69,HabboWindowStyle.const_30,HabboWindowParam.const_63,new Rectangle(0,0,param1.width,66)));
               param1.addListItem(_loc7_);
            }
            _loc10_ = _loc6_[_loc8_];
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_345,HabboWindowStyle.const_47,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
            _loc11_.mouseThreshold = 0;
            _loc12_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",HabboWindowType.const_361,HabboWindowStyle.const_47,HabboWindowParam.const_63,new Rectangle(0,0,66,66),this.onImgSel,_loc10_.id));

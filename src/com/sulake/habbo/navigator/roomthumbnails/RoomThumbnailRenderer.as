package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_537:int = 10;
      
      private static const const_1088:int = 32;
      
      private static const const_1560:int = 8;
      
      private static const const_1561:int = -16;
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_1088 / 2);
         return new Point(param1 * const_1088 + _loc3_,param2 * const_1560);
      }
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(this._navigator.windowManager.createWindow("bitmap","",HabboWindowType.const_361,HabboWindowStyle.const_47,0 | (!!param3 ? HabboWindowParam.const_44 : HabboWindowParam.const_47),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1018.getImage(ThumbnailEditorModel.const_39,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_1018.getImage(ThumbnailEditorModel.const_39,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_1018.getImage(ThumbnailEditorModel.const_65,param2);
         if(_loc3_ == null)
         {
      ...
      private function refreshObj(param1:BitmapData, param2:RoomThumbnailObjectData) : void
      {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1561,_loc4_.y + const_1559 - _loc5_.height),null,null,true);
      }

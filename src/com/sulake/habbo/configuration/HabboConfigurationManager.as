package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      public function HabboConfigurationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_765 = (param2 & 0) > 0;
         this.var_950 = new Dictionary();
         if(!this.var_765)
         {
            lock();
         }
         ...
         this.var_621 = this.getKey("url_prefix");
         if(this.var_621 != null && this.var_621.length > 0)
         {
            this.setKey("client.fatal.error.url",this.var_621 + "/flash_client_error");
         }
         this.init();
      }
      ...
      private function parseConfiguration(param1:String) : void
      {
         ...
         this.var_621 = this.getKey("url.prefix");
         if(this.var_621.length > 0)
         {
            externalAccessDomain = this.var_621.replace("http://","");
      ...
      {
         var _loc2_:String = this.var_950[param1] as String;
         return _loc2_ != null;
      }
      
      public function getKey(param1:String, param2:String = "", param3:Dictionary = null) : String
      {
         var _loc4_:String = this.var_950[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",this.var_621);
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false, param4:Boolean = false) : void
      {
         if(param4)
         {
            if(this.var_950[param1] == null)
            {
               Logger.log(param1 + "=" + param2);
            }
         }
         if(this.var_1751.indexOf(param1) < 0 || param3)
         {
            this.var_950[param1] = param2;
         }
         if(param3)
         {
            this.var_1751.push(param1);
         }
      }
      ...
      {
         var _loc3_:String = this.var_950[param1] as String;
         if(_loc3_ == null)
         {
            return param2;
         }

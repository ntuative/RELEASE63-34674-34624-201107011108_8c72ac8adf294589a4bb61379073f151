package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1838:String = "sample_22khz";
      
      public static const const_1954:String = "sample_11khz";
      
      public static const const_1822:String = "sample_16bit";
      
      public static const const_1992:String = "sample_8bit";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_173 * this.var_84;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            if(_loc11_ >= _loc10_ - 1 - const_1050)
            {
               _loc12_ *= (_loc10_ - _loc11_ - 1) / Number(const_1050);
            }
            ...
            _loc9_ *= _loc5_;
            _loc9_ += _loc14_;
            if(_loc11_ % this.var_173 == this.var_173 - 1)
            {
               this.var_127[int(_loc11_ / this.var_173)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_127.length * this.var_173 * this.var_84;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_173 * this.var_84;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
      ...
      public function setUsageFromSong(param1:int, param2:uint) : void
      {
         ...
         if(this.var_632.indexOf(param1) == -1)
         {
            this.var_632.push(param1);
         }
      ...
      public function isUsedFromSong(param1:int) : Boolean
      {
         ...
         return this.var_632.indexOf(param1) != -1;
      }
   }
}

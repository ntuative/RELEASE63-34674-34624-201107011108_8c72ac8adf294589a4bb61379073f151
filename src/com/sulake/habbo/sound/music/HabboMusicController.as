package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1462:int = HabboMusicPrioritiesEnum.const_138;
      ...
      private var var_523:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_787.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_787.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_787)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_729,this.onJukeboxInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_299,this.onJukeboxDispose);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_882,this.onSoundMachineInit);
         this.var_94.addEventListener(RoomEngineSoundMachineEvent.const_905,this.onSoundMachineDispose);
         this.var_1182 = new Timer(1000);
         this.var_1182.start();
         this.var_1182.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1772)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_434)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_94)
            {
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_729,this.onJukeboxInit);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_299,this.onJukeboxDispose);
               this.var_94.removeEventListener(RoomEngineSoundMachineEvent.const_882,this.onSoundMachineInit);
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_275.length)
         {
            ...
            if(_loc3_.id != this.var_1461 && _loc4_ != null && _loc4_.ready)
            {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_771));
         Logger.log("Requested song info\'s : " + this.var_771);
         this.var_771 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               while(this.var_772.indexOf(_loc6_.id) != -1)
               {
                  this.var_772.splice(this.var_772.indexOf(_loc6_.id),1);
      ...
      private function playSongObject(param1:int, param2:int) : Boolean
      {
         ...
         this.var_1772 = this.getSongRequestCountAtPriority(param1);
         this.var_1461 = param2;
         if(this._priorityPlaying <= const_1462)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2358 != param1.id || _loc3_ > this.var_2357 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2358 = param1.id;
            this.var_2357 = _loc3_;
         }
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_523 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_94,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_523 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;

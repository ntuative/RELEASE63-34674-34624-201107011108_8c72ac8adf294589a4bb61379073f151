package com.sulake.habbo.messenger
{
   ...
   public class MessengerView implements IDisposable
   {
      ...
      private var var_1570:ConversationView;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         this.var_1570.addMessage(param2);
      }
      ...
      private function prepareContent() : void
      {
         ...
         this.var_1040 = new ConversationsTabView(this.var_152,this.var_16);
         this.var_1040.refresh();
         this.var_1033 = ITextFieldWindow(this.var_16.findChildByName("message_input"));
         this.var_1033.addEventListener(WindowKeyboardEvent.const_197,this.onMessageInput);
         this.var_1570 = new ConversationView(this.var_152,this.var_16);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_895,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1298,true);
         this.var_16.center();
      }
      ...
      private function onMessageInput(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc2_ = 120;
            _loc3_ = this.var_1033.text;
            if(_loc3_.length > _loc2_)
            {
               this.var_1033.text = _loc3_.substring(0,_loc2_);
            }
         }
      }
      ...
      {
         var _loc1_:String = this.var_1033.text;
         ...
         this.var_1033.text = "";
         this.var_152.conversations.addMessageAndUpdateView(new Message(Message.const_862,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }

package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1497:int = 10;
      
      private static const const_1062:int = 100;
      
      private static const const_1498:int = 20;
       
      
      private var var_152:HabboMessenger;
      
      private var var_2484:IScrollbarWindow;
      
      private var var_1832:IContainerButtonWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_152 = param1;
         this.var_1832 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_67 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2484 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1062 + const_1498)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1497;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1832.enable();
         }
         else
         {
            this.var_1832.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_67.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_541.messages.length - const_1062);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_862 || param3.type == Message.const_797 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_152.send(new FollowFriendMessageComposer(this.var_541.id));

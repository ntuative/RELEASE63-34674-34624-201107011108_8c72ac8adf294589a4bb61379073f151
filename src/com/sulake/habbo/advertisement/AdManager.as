package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_367:AdImageRequest;
      
      private var var_1165:BitmapData = null;
      
      private var var_1167:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2306 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2308 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2307 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1739 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1166 == 0)
         {
            this.var_1166 = getTimer();
            return false;
         }
         if(this.var_1739 > 0 && this.var_1738 >= this.var_1739)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1166;
         if(_loc1_ > this.var_2308)
         {
            ++this.var_1738;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1446 != "")
         {
            ...
            {
               this.var_240 = new Timer(this.var_2307,1);
            ...
            this.var_240.start();
            _loc4_ = new URLRequest(this.var_1446);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_514,param1.bitmapData,this.var_2305));
            this.var_1166 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_530));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_367 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_367 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_367 = new AdImageRequest(this.var_367.roomId,this.var_367.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_367 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_589,this.var_367.roomId,this.var_367.roomCategory,_loc4_,_loc2_.assetName,this.var_367.clickURL,this.var_1165,this.var_1167));
            this.var_367 = null;
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1167 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_619.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_619.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_849,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }

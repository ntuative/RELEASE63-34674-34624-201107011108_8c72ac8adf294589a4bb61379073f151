package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2059:uint = 1;
      
      protected static const const_2057:uint = 2;
      
      protected static const const_2060:uint = 4;
      
      protected static const const_2058:uint = 3;
      
      protected static const name_5:uint = 7;
      
      public static const const_1823:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1366:Boolean = false;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         if(const_1366)
         {
            if(var_1112.indexOf(param1) == -1)
            {
               var_1112.push(param1);
            }
            throttle();
         }
         else
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1366)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_901[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_901.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_901.length < const_1815 && false)
            {
               _loc1_ = var_1112.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1150 ? uint(this.var_1425 - this.var_2263) : uint(getTimer() - this.var_2263);
      }
      ...
      {
         if(!this.var_1150 && !_disposed && this.var_1426 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.method_17(this.var_269,const_1823 - this.var_1426);
            if(this.var_3058)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_512 == LibraryLoader.const_2058)
         {
      ...
      protected function method_17(param1:URLRequest, param2:int) : void
      {
         var _loc9_:int = 0;
         var _loc10_:* = null;

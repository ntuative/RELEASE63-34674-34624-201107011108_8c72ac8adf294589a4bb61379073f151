package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1949:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_823 = null;
         for each(_loc3_ in this.var_1543)
         {
         }
         var _loc5_:* = null;
         this.var_1272 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1228:
               _loc3_ = new SocketConnection(param1,this,this.var_1949);
               break;
            default:
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1543)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)

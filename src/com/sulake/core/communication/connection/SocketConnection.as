package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1796:int = 10000;
      ...
      private var var_522:ByteArray;
      
      private var var_1178:IEncryption;
      
      private var var_767:IProtocol;
      
      private var _id:String;
      
      private var var_1177:IMessageClassManager;
      
      private var var_274:ICoreCommunicationManager;
      
      private var var_521:IConnectionStateListener;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_274 = param2;
         this.var_522 = new ByteArray();
         this.var_1177 = new MessageClassManager();
         this.var_83 = new Socket();
         this.var_214 = new Timer(const_1796,1);
      ...
      public function init(param1:String, param2:uint = 0) : Boolean
      {
         if(this.var_521)
         {
            this.var_521.connectionInit(param1,param2);
         }
         Security.loadPolicyFile("xmlsocket://" + param1 + ":" + param2);
         this.var_214.start();
         this.var_768 = getTimer();
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_1177.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
         ...
         var _loc6_:ByteArray = this.var_767.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_521)
         {
            this.var_521.messageSent(String(_loc4_),_loc6_.toString());
         }
         if(this.var_1178 != null)
         {
            _loc3_ = this.var_1178.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      {
         this.var_1177.registerMessages(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_767.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_767.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1178 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_767.getMessages(this.var_522,receivedMessages);
         try
         {
            for each(message in receivedMessages)
            {
               ...
               if(this.var_521)
               {
                  this.var_521.messageReceived(String(id),data.toString());
               }
               eventClasses = this.var_1177.getMessageEventClasses(id);
               events = new Array();
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_522,offset);
               this.var_522 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_522.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_522.writeByte(this.var_83.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_214.stop();
         this.var_1760 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_768));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_1760 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_768));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_768));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_768));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_768));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_768));

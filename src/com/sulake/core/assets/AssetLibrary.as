package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1365:String = "AssetLibraryReady";
      
      public static const const_843:String = "AssetLibraryLoaded";
      
      public static const const_2009:String = "AssetLibraryUnloaded";
      
      public static const const_1762:String = "AssetLibraryLoadError";
      
      private static const const_681:String = "name";
      
      private static const const_1048:String = "asset";
      ...
      private static var var_1785:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_526:uint = 0;
      
      private static var var_959:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_526;
         this.var_441 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1047);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1048);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_959.splice(var_959.indexOf(this),1);
            --var_526;
            this.var_527 = null;
            this.var_961 = null;
            this.var_172 = null;
      ...
      {
         if(this.var_630 == param1.url && this.var_960)
         {
            if(!this.var_962 && param2)
            {
      ...
      public function unload() : void
      {
         ...
         this.var_960 = false;
         this.var_630 = null;
         dispatchEvent(new Event(AssetLibrary.const_2009));
      }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1242,this.assetLoadEventHandler);
      ...
      {
         return this.var_172[param1] != null || (this.var_629 != null ? this.var_629[param1] != null : false);
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               var_1785.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_441.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_441[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_441[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_441)
         {
            _loc3_ = AssetTypeDeclaration(this.var_441[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_441)
         {
            _loc4_ = AssetTypeDeclaration(this.var_441[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_960 = true;
         dispatchEvent(new Event(AssetLibrary.const_843));
         dispatchEvent(new Event(AssetLibrary.const_1365));
         if(this.var_962)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1762));
         this.var_44 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1047);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1048);
            if(_loc2_ != null)
            {
               _loc5_ = null;

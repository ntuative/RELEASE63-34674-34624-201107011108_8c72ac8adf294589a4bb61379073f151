   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_119 is BitmapDataAsset)
         {
            ...
            this.var_1492 = BitmapDataAsset(this.var_119).var_1492;
            this.var_1491 = BitmapDataAsset(this.var_119).var_1491;
            if(this._bitmap != null)
            {
               this.var_119 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1492 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1491 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }

package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1770:uint = 0;
      
      public static const const_945:uint = 1;
      
      public static const const_1347:uint = 2;
      
      public static const const_765:uint = 4;
      
      public static const const_1936:uint = 8;
      
      public static const const_1990:uint = 16;
      
      public static const const_2274:uint = 64;
      
      public static const const_2316:uint = 128;
      
      public static const const_1368:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            case GraphicContext.const_945:
               this.var_931 = true;
               this.setDisplayObject(new Bitmap());
               this.method_12(param3.width,param3.height);
               break;
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         {
            this.method_12(param1.width,param1.height);
         }
         x = param1.x;
         y = param1.y;
      ...
      protected function method_12(param1:int, param2:int) : BitmapData
      {
         ...
         if(this.var_931)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2247,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2247,16777215);
                  }
                  var_362 += bitmap.width * bitmap.height * 4;
               }

   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_356 = SkinLayoutEntity.const_635;
                  break;
               case "move":
                  _loc5_.var_356 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_356 = SkinLayoutEntity.const_656;
                  break;
               case "tiled":
                  _loc5_.var_356 = SkinLayoutEntity.const_374;
                  break;
               case "center":
                  _loc5_.var_356 = SkinLayoutEntity.const_661;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_357 = SkinLayoutEntity.const_635;
                  break;
               case "move":
                  _loc5_.var_357 = SkinLayoutEntity.const_342;
                  break;
               case "strech":
                  _loc5_.var_357 = SkinLayoutEntity.const_656;
                  break;
               case "tiled":
                  _loc5_.var_357 = SkinLayoutEntity.const_374;
                  break;
               case "center":
                  _loc5_.var_357 = SkinLayoutEntity.const_661;
            }
         }

package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1550:String = "skin";
      
      private static const const_1553:String = "bitmap";
      
      private static const const_1552:String = "fill";
      ...
      private var var_1935:Dictionary;
      
      private var var_2640:Dictionary;
      
      private var var_2639:Dictionary;
      
      private var var_2638:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1935 = new Dictionary();
         this.var_2640 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1935,this.var_2640);
         this.var_2639 = new Dictionary();
         this.var_2638 = new Dictionary();
         StateCodeTable.fillTables(this.var_2639,this.var_2638);
         this.var_459 = new Dictionary();
         this.var_459[const_1550] = BitmapSkinRenderer;
         this.var_459[const_1553] = BitmapDataRenderer;
         this.var_459[const_1552] = FillSkinRenderer;
         this.var_459[const_1548] = TextSkinRenderer;
         this.var_459[const_1549] = LabelRenderer;
         this.var_459[const_1551] = ShapeSkinRenderer;
         this.var_459[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_459[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_364 == null)
         {
            var_364 = new Array();
            var_364.push(WindowState.const_73);
            var_364.push(WindowState.const_87);
            var_364.push(WindowState.const_96);
            var_364.push(WindowState.const_55);
            var_364.push(WindowState.const_94);
            var_364.push(WindowState.const_89);
            var_364.push(WindowState.const_91);
            var_364.push(WindowState.const_106);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_3036 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_1935[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1017[param1] == null)
         {
            this.var_1017[param1] = new Array(const_1087);
         }
         this.var_1017[param1][param2] = param3;
         if(this.var_1016[param1] == null)
         {
            this.var_1016[param1] = new Array(const_1087);
         }
         this.var_1016[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1017[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1016[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_103)

   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               _loc2_ = this.var_932[_loc1_] as BitmapData;
               _loc2_.dispose();
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc10_.var_356 == SkinLayoutEntity.const_342)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_656)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_374)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_661)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_357 == SkinLayoutEntity.const_342)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_656)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_374)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_661)
                  {
                  ...
                  else if(_loc10_.var_357 == SkinLayoutEntity.const_374 || _loc10_.var_356 == SkinLayoutEntity.const_374)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_356 == SkinLayoutEntity.const_342)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_357 == SkinLayoutEntity.const_342)
               {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_932[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)

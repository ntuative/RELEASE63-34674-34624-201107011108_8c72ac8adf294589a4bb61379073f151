package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1122:uint = 2;
      ...
      public function WindowRendererItem(param1:WindowRenderer, param2:DrawBufferAllocator, param3:ISkinContainer)
      {
         ...
         this.var_1621 = 4294967295;
         this.var_1080 = 0;
         this.var_786 = new ColorTransform();
         this.var_1143 = new Matrix();
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1122) : uint(const_705);
         var _loc6_:Boolean = this.var_205.width > 0 && this.var_205.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1080))
            {
               _loc5_ = const_1121;
            }
         }
         ...
         if(_loc5_ != const_705)
         {
            this.var_1621 = this.var_1080;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1121)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_703)
                  {
                     ...
                     _loc7_.draw(param1,this.var_140,this.var_140.rect,this.var_1080,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     this.var_1143.tx = param2.x;
                     this.var_1143.ty = param2.y;
                     this.var_786.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_140,this.var_1143,this.var_786,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1621;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1307:
               ...
               break;
            case WindowRedrawFlag.const_953:
               this.var_1080 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1080 != this.var_1621)
               {
                  this.var_703 = true;
                  _loc4_ = true;
               }

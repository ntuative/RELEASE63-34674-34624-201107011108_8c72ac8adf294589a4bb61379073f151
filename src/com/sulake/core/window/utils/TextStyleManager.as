package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_518:Array;
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_97[const_205],var_97[ITALIC],var_97[BOLD]];
            var_97.reset();
            var_97[const_205] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_518.indexOf(_loc4_.name) == -1)
            {
               var_518.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_680) != countSubStrings(param1,const_679))
         {
            throw new Error("Mismatching amount of \"" + const_680 + "\" versus \"" + const_679 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1435) == 0)
            {

package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1223:String = "_EXCLUDE";
      
      public static const const_2185:String = "_INCLUDE";
      
      public static const const_2329:String = "_TEMP";
      
      private static const const_1717:String = "layout";
      
      private static const const_1151:String = "window";
      
      private static const const_1152:String = "variables";
      
      private static const const_1150:String = "filters";
      
      private static const const_681:String = "name";
      
      private static const const_1716:String = "style";
      
      private static const const_727:String = "params";
      
      private static const const_1718:String = "tags";
      ...
      private static const const_1713:String = "visible";
      
      private static const const_1714:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1240:String = "blend";
      
      private static const const_1708:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1715:String = "treshold";
      
      private static const const_1710:String = "children";
      
      private static const const_1709:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1705:String = "height_min";
      
      private static const const_1706:String = "height_max";
      
      private static const const_726:String = "true";
      
      private static const const_200:String = "0";
      
      private static const const_1711:String = "$";
      
      private static const const_1690:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1707:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1712:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      {
         param1 = param1.replace(const_1712,const_50);
         return param1.replace(const_1707,const_50);
      }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1717)
         {
            _loc8_ = param1.child(const_1152);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc4_ = param1.child(const_1151);
         ...
         if(param1.localName() == const_1151)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         style = uint(this.parseAttribute(xml,const_1716,variables,style));
         params = uint(this.parseAttribute(xml,const_727,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1718,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1713,variables,visible.toString()) == const_726;
         ...
         caption = unescape(String(this.parseAttribute(xml,const_1714,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1690);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1152)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1709,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1705,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1706,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_726;
         blend = Number(this.parseAttribute(xml,const_1240,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1708,variables,window.clipping.toString()) == const_726;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1715,variables,window.mouseThreshold.toString()));
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1223) == -1)
                  {

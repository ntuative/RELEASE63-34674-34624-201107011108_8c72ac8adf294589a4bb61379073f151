package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_936:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_363 = new Array();
            var_363[0] = MouseCursorType.const_371;
            var_363[1] = MouseCursorType.const_30;
            var_363[2] = MouseCursorType.const_371;
            var_363[3] = MouseCursorType.const_371;
            var_363[4] = MouseCursorType.const_371;
            var_363[5] = MouseCursorType.const_30;
            var_363[6] = MouseCursorType.const_371;
         }
         if(var_317 == null)
         {
            var_317 = new Array();
            ...
            var_317[3] = WindowState.const_73;
            var_317[4] = WindowState.const_55;
            var_317[5] = WindowState.const_96;
            var_317[6] = WindowState.const_87;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_71 = state.var_1406 as WindowController;
         this.var_189 = state.var_1408 as WindowController;
         this.var_170 = state.renderer;
         this.var_936 = state.var_1405;
         eventQueue.begin();
         this.var_751.x = -1;
         this.var_751.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_751.x || event.stageY != this.var_751.y)
            {
               this.var_751.x = event.stageX;
               this.var_751.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_751,array,WindowParam.const_31);
            }
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_71 && !this.var_71.disposed)
                     {
                        ...
                        {
                           this.var_936.mouseEventReceived(event.type,this.var_71);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1406 = this.var_71;
         state.var_1408 = this.var_189;
         state.renderer = this.var_170;
         state.var_1405 = this.var_936;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_579))
         {

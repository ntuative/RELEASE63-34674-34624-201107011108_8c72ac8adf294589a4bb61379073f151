package com.sulake.core.window.utils
{
   ...
   public class MouseCursorControl
   {
      ...
      private static var var_1537:Dictionary = new Dictionary();
            ...
            else
            {
               ...
               switch(_type)
               {
                  ...
                  case MouseCursorType.ARROW:
                     ...
                     break;
                  case MouseCursorType.const_371:
                     Mouse.cursor = MouseCursor.BUTTON;
                     break;
                  case MouseCursorType.const_885:
                  case MouseCursorType.const_286:
                  case MouseCursorType.const_1980:
                  case MouseCursorType.const_1996:
      ...
      {
         if(var_133 && _type != MouseCursorType.const_30)
         {
            Mouse.hide();
            var_338 = false;
         }

package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1467:String = "_TITLE";
      
      private static const const_1593:String = "_HEADER";
      
      private static const const_1592:String = "_CONTENT";
      
      private static const const_1591:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1582:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1467) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1582 = findChildByTag(const_1593) as IHeaderWindow;
            if(!this.var_1582)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_207 = findChildByTag(const_1592) as IWindowContainer;
            if(!this.var_207)
            {
      ...
      {
         return findChildByTag(const_1591) as IScalerWindow;
      }
      ...
      {
         return this.content != null && this.var_1150 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_344);
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_309,_loc3_.left,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_297,_loc3_.top,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_256,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         return _loc1_;
      }

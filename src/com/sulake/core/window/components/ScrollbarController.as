package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1513:String = "increment";
      
      private static const const_1514:String = "decrement";
      
      private static const const_1071:String = "slider_track";
      
      private static const const_693:String = "slider_bar";
      ...
      public function ScrollbarController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0, param12:IScrollableWindow = null)
      {
         ...
         var_191 = false;
         this.var_18 = param12;
         this._horizontal = param2 == WindowType.const_547;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_18 != null && !this.var_18.disposed)
         {
            ...
            this.var_18.removeEventListener(WindowEvent.const_618,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_618,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1004 != null)
         {
            _loc2_ = this.var_1004;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1004 = _loc3_.value as String;
               this.var_18 = null;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_1071) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_693) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_693:
         ...
         if(param2.type == WindowEvent.const_566)
         {
            if(this.var_18 == null)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_756)
         {
            ...
            else if(param2.name == const_1514)
            {
               if(this.var_18)
               {
                  this.var_1236 = true;
            ...
            else if(param2.name == const_1071)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_693).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1004) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1004) as IScrollableWindow;
               if(_loc1_)
               {

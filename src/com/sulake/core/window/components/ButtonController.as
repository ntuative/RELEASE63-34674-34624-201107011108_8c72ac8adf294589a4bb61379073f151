package com.sulake.core.window.components
{
   ...
   public class ButtonController extends InteractiveController implements IButtonWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1406:Number = 0.5;
         ...
         if(event is WindowEvent)
         {
            switch(event.type)
            {
               ...
               case WindowEvent.const_291:
                  try
                  {
                     getChildByName(TEXT_FIELD_NAME).blend = getChildByName(TEXT_FIELD_NAME).blend + const_1406;
                  }
                  catch(e:Error)
                  {
                  }
         ...
         else if(event is WindowTouchEvent)
         {
            ...
            switch(event.type)
            {
               ...
               case WindowTouchEvent.const_1169:
                  type = "null";
                  break;
               case WindowTouchEvent.const_756:
                  type = "null";
            }

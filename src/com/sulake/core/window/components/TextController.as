package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1405:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_928:Number;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_435,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_435 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_435,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_944 ? true : null;
         }
      ...
      {
         this.var_928 = param1;
         this._field.scrollH = this.var_928 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_928 * this.maxScrollH,this.var_602 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_943,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1248));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1328 ? new PropertyStruct(PropertyDefaults.const_857,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1194) : PropertyDefaults.const_1971);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_314,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1208 ? new PropertyStruct(PropertyDefaults.const_1299,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1337) : PropertyDefaults.const_2020);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_933) ? new PropertyStruct(PropertyDefaults.const_456,this._field.textColor,PropertyStruct.const_152,true) : PropertyDefaults.const_1373);
         ...
         _loc1_.push(this.var_42.left != PropertyDefaults.const_860 ? new PropertyStruct(PropertyDefaults.const_309,this.var_42.left,PropertyStruct.const_36,true) : PropertyDefaults.const_744);
         _loc1_.push(this.var_42.top != PropertyDefaults.const_871 ? new PropertyStruct(PropertyDefaults.const_297,this.var_42.top,PropertyStruct.const_36,true) : PropertyDefaults.const_834);
         _loc1_.push(this.var_42.right != PropertyDefaults.const_1001 ? new PropertyStruct(PropertyDefaults.const_259,this.var_42.right,PropertyStruct.const_36,true) : PropertyDefaults.const_1010);
         _loc1_.push(this.var_42.bottom != PropertyDefaults.const_840 ? new PropertyStruct(PropertyDefaults.const_256,this.var_42.bottom,PropertyStruct.const_36,true) : PropertyDefaults.const_1015);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1246 ? new PropertyStruct(PropertyDefaults.const_816,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1925);

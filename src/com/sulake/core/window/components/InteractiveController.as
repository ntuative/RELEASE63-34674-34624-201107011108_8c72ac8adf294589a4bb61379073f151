package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_492)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_492)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_990,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1947);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1311)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_842,param1.toolTipDelay,PropertyStruct.const_314,true));
         }
         else
         {
      ...
      {
         this.var_1415 = param1 == null ? "null" : param1;
      }

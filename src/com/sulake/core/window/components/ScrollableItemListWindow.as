package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1346:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_489)
         {
            this.var_489.removeEventListener(WindowEvent.const_291,this.scrollBarEventProc);
            this.var_489.removeEventListener(WindowEvent.const_313,this.scrollBarEventProc);
            this.var_489 = null;
         }
         if(this.var_1346)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1346)
         {
            this.var_1346 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_489)
         {
            this.var_489 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_489)
            {
               this.var_489.addEventListener(WindowEvent.const_291,this.scrollBarEventProc);
               this.var_489.addEventListener(WindowEvent.const_313,this.scrollBarEventProc);
            }
         }
         return this.var_489;
      }
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_313)
         {
            this.hideScrollBar();
         }
      }

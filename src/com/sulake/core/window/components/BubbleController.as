   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_889;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_867,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         if(this.var_889 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_851,this.var_889,PropertyStruct.const_36,true));
         }
         else
         {

package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1415 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1347,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_765 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_926,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1827);
         _loc1_.push(this.var_1424 != PropertyDefaults.const_1359 ? new PropertyStruct(PropertyDefaults.const_1025,this.var_1424,PropertyStruct.const_38,true) : PropertyDefaults.const_1897);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1289 ? new PropertyStruct(PropertyDefaults.const_828,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1829);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1343 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1866);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_926:
                  ...
                  break;
               case PropertyDefaults.const_1364:

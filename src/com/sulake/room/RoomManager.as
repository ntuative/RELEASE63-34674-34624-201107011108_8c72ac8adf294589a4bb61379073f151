package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         events.addEventListener(RoomContentLoadedEvent.const_397,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_493,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_936,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_699 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_699 == null || this.var_572 == null)
         {
            return;
         }
         this._state = const_1908;
         if(this.var_1319 != null)
         {
            _loc1_ = this.var_1319;
            this.var_1319 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_700.indexOf(_loc5_) < 0)
            {
               this.var_59.loadObjectContent(_loc5_,events);
               this.var_700.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1163;
         return true;
      }
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_699.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_699 != null)
         {
            return this.var_699.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_59.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_700.indexOf(param1);
            if(_loc2_ >= 0)
            {
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         {
            _loc2_ = this.var_1076[0];
            this.var_1076.splice(0,1);
            ...
            _loc5_ = getTimer();
            if(_loc5_ - _loc1_ >= CONTENT_PROCESSING_TIME_LIMIT_MILLISECONDS && this.var_2809)
            {
               this.var_2042 = true;
               break;
            }
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_59 == null || this.var_572 == null)
         {
            return;
         }
                     ...
                     if(_loc15_ != null)
                     {
                        ...
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_699.createRoomObjectLogic(_loc6_);

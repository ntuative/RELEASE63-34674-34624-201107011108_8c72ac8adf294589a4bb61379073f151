package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_1346:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1946 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_462.assign(this.var_106);
         this.var_462.x *= this.var_463;
         this.var_462.y *= this.var_461;
      ...
      {
         if(this.var_463 != param1 * this.var_1947)
         {
            this.var_463 = param1 * this.var_1947;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_461 != param1 * this.var_1945)
         {
            this.var_461 = param1 * this.var_1945;
            ++this.var_181;
         }
      }
      ...
      {
         if(this.var_460 != param1 * this.var_1946)
         {
            this.var_460 = param1 * this.var_1946;
            ++this.var_181;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_463;
         this.var_106.y /= this.var_461;
         this.var_106.z /= this.var_460;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_464.x;
         var _loc3_:Number = this.var_464.y;
         var _loc4_:Number = this.var_464.z;
         this.var_464.assign(param1);
         this._direction.assign(param1);
         if(this.var_464.x != _loc2_ || this.var_464.y != _loc3_ || this.var_464.z != _loc4_)
         {
            ++this.var_181;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1267.assign(this.var_185);
         }
         else
         {
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_463,this.var_106.y * this.var_461,this.var_106.z * this.var_460);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_185;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_463,param2.y * this.var_461,param2.z * this.var_460);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_463,param3.y * this.var_461,param3.z * this.var_460);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_463,param4.y * this.var_461,param4.z * this.var_460);

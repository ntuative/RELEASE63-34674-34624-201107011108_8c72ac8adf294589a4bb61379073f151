package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1874 || param2 != this.var_1875)
         {
      ...
      {
         if(this.var_1516 > 255 || bitmapData == null)
         {
            return false;
         }

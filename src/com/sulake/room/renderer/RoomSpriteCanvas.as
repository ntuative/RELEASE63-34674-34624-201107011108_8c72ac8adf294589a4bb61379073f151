package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1654:int = 50;
      
      private static const const_1127:Number = 60;
      
      private static const const_1655:Number = 50;
      ...
      private var var_303:BitmapDataCache;
      
      private var var_713:RoomObjectCache;
      
      private var var_577:Array;
      
      private var var_709:Array;
      
      private var var_1629:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2876:Number = -1.0E7;
      
      private var var_2877:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_304.addChild(this.var_115);
         ...
         this.var_303 = new BitmapDataCache(16,32,1);
         var _loc6_:* = null;
         ...
         this.var_713 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_580.x -= param1 - this.var_711;
         this.var_711 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_580.y -= param1 - this.var_708;
         this.var_708 = param1;
      }
      ...
      public function set useMask(param1:Boolean) : void
      {
         ...
         {
            this.var_1073 = true;
            if(this.var_163 != null && !this.var_304.contains(this.var_163))
            {
               this.var_304.addChild(this.var_163);
               this.var_115.mask = this.var_163;
            }
         }
         else if(!param1 && this.var_1073)
         {
            this.var_1073 = false;
            if(this.var_163 != null && this.var_304.contains(this.var_163))
            {
               this.var_304.removeChild(this.var_163);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_709.length)
            {
               this.cleanSprite(this.var_709[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_709 = [];
         }
      ...
      {
         this.var_713.removeObjectCache(param1);
      }
      
      public function render(param1:int) : void
      {
         this.var_2086 = !this.var_2086;
         ...
         if(this.var_578 != this.var_2882 || this.var_579 != this.var_2879)
         {
            _loc8_ = true;
         }
         if(this.var_115.x != this.var_711 || this.var_115.y != this.var_708)
         {
            this.var_115.x = this.var_711;
            this.var_115.y = this.var_708;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_577.sortOn("z",0 | 0);
         if(_loc5_ < this.var_577.length)
         {
            this.var_577.splice(_loc5_);
         }
         var _loc9_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc9_ = this.var_577[_loc4_] as SortableSprite;
            if(_loc9_ != null)
            {
         ...
         this.var_2882 = this.var_578;
         this.var_2879 = this.var_579;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1630 > 0)
         {
            ...
            if(_loc2_ > const_1127 * 3)
            {
               Logger.log("Really slow frame update " + _loc2_ + "ms");
               this.var_2881 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_871;
               if(this.var_871 == const_391 + 1)
               {
                  this.var_533 = _loc2_;
                  this.var_2088 = this.var_2878;
               }
               else if(this.var_871 > const_391 + 1)
               {
                  _loc3_ = Number(this.var_871 - const_391);
                  this.var_533 = this.var_533 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_2088 = this.var_2088 * (_loc3_ - 1) / _loc3_ + Number(this.var_2878) / _loc3_;
                  if(this.var_871 > const_391 + const_1654)
                  {
                     this.var_871 = const_391;
                     if(!this.var_1336 && this.var_533 > const_1127)
                     {
                        this.var_1336 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1336 && this.var_533 < const_1655)
                     {
                        this.var_1336 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_713.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_713.getObjectCache(param2);
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_2086 && this.var_1336);
         ...
         _loc13_ += int(this.var_578 / 2);
         _loc14_ += int(this.var_579 / 2);
         var _loc16_:int = 0;
         var _loc17_:* = null;
         var _loc18_:* = null;
         var _loc19_:int = 0;
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_711;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_708;
                  if(this.rectangleVisible(_loc19_,_loc20_,_loc22_.width,_loc22_.height))
                  {
                     ...
                     if(_loc17_ == null)
                     {
                        ...
                        this.var_577.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_711;
                     _loc17_.y = _loc20_ - this.var_708;
      ...
      {
         if(param1 < this.var_578 && param1 + param3 >= 0 && (param2 < this.var_579 && param2 + param4 >= 0))
         {
            if(!this.var_3092)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_578)
         {
            param3 -= this.var_578 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_579)
         {
            param4 -= this.var_579 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2880)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_1088)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_709.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= this.var_1088)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_872 || this.var_872 == 0)
         {
            _loc4_ = this.var_1088 - 1;
            while(_loc4_ >= param1)
            {
      ...
      {
         if(param1 < 0 || param1 >= this.var_577.length)
         {
            return null;
         }
         return this.var_577[param1] as SortableSprite;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:Boolean, param5:int) : BitmapData
      {
         ...
         if((param3 || param4) && param5 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc6_ = this.var_303.getBitmapData(_loc7_);
            }
            if(_loc6_ == null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(param2.length > 0)
                  {
                     this.var_303.addBitmapData(_loc7_,_loc6_);
                  }
                  return _loc6_;
               }
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(name.length > 0)
         {
            finalData = this.var_303.getBitmapData(cacheName);
            if(!allowCreation)
            {
               return finalData;
            }
         ...
         if(finalData == null)
         {
            ...
            if(name.length > 0)
            {
               this.var_303.addBitmapData(cacheName,finalData);
            }
         }
         return finalData;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_711;
         param2 -= this.var_708;
         this.var_580.x = param1;
         this.var_580.y = param2;
         if(this.var_1337 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_2085;
         }
         this.var_2085 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1337;
         return this.var_2085;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_578 / 2;
         var _loc12_:Number = param2 - this.var_579 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_2087,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_710.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_710.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2876 || param2 != this.var_2877)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_710.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_710.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
         ...
         while(_loc1_ < this.var_410.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1629.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1337 == 0)
         {
            this.checkMouseHits(this.var_580.x,this.var_580.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1337 = 0;
         ++this.var_2087;
      }
